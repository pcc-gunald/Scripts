DECLARE  @srcFacID VARCHAR(100)		=	1
		...
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w27-cli0020.851c37dfbe45.database.windows.net].[us_ssch]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w19-cli0003.3055e0bc69f6.database.windows.net].[us_mea]'
