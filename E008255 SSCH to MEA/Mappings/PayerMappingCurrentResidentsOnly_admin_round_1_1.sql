...
BEGIN
	SET @srcFacID = 1
	SET @dstFacID = 2
	SET @srcServer = '[pccsql-use2-prod-w27-cli0020.851c37dfbe45.database.windows.net].[us_ssch]'
	SET @dstServer = '[pccsql-use2-prod-w19-cli0003.3055e0bc69f6.database.windows.net].[us_mea]'
