    ...
    select * from LoadEIMaster_PMO_Groups where PMONumber like '%58899%'
...
insert into #temp_fac values('58899',5,194) 
    ...
    'USEI1029' as [SrcOrgCode],-- source
    'pcc_staging_db58899' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
    'USEI41' as [DstOrgCode],--destination
    'USEI41' as [DstOrgCodeProd], --org code of current destination
    src_id as [SrcFacID],--
    src_id as [StgFacID],--
    dest_id as [DstFacID],--
    ...
    'E1,E2,E2a,E3,E4,E5,E6,E7a,E7b,E7c,E8,E12a,E12b,E11,E9,E10,E13,E17,E20,E21,E22' as [ModList],
