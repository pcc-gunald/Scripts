...
--script:
/*
select * into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
...
where client_id in (select client_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].clients with (nolock) where fac_id = 1)) and fac_id <> 1)
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in as_footnote2 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct s.* 
...
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in pho_phys_order4 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
...
WHERE c.fac_id = 1)  
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in pho_phys_order5 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
...
(select created_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,1)
union 
select revision_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,1)
union 
select published_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,1)
union 
select retired_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order_set with (nolock) where fac_id  in (-1,1)
union 
select reactivated_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,1))
and fac_id <> 1)
and fac_id <> 1
...
where userid in 
(select userid from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit with (nolock) where cp_sec_user_audit_id in 
(select created_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order with (nolock) where  fac_id  in (-1,1)
union 
select revision_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order with (nolock) where  fac_id  in (-1,1)
union 
select published_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order with (nolock) where  fac_id  in (-1,1)
union 
select retired_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order with (nolock) where  fac_id  in (-1,1)
union 
select reactivated_by_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_std_order with (nolock) where  fac_id  in (-1,1))
and fac_id <> 1)
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in pho_std_order5 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct * from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].sec_user with (nolock)
where userid in (SELECT distinct a.userid FROM [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit a with (nolock)
...
where b.client_id in (select client_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].clients with (nolock) where fac_id = 1))  
and userid not in (-10000, -998)
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in allergy3 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct * from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].sec_user with (nolock)
where userid in (SELECT distinct a.userid FROM [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit a with (nolock)
...
and userid not in (-10000, -998)
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in allergy_audit2 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct * from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].sec_user with (nolock)
where userid in (SELECT distinct a.userid FROM [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit a with (nolock)
...
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in mpi_history16 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct * from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].sec_user with (nolock)
where userid in (select userid from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit with (nolock)
where cp_sec_user_audit_id in  (select  sec_user_audit_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].immunization_strikeout with (nolock)
...
where client_id in (select client_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].clients with (nolock) where fac_id in (1)))
and fac_id not in (1))
and fac_id not in (1)
...
where client_diagnosis_id in (select client_diagnosis_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].diagnosis with (nolock) where fac_id in (1)))
and fac_id not in (1))
and fac_id not in (1)
...
and fac_id <> 1
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in pho_admin_order2 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
select distinct * from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].sec_user with (nolock)
where userid in (select userid from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].cp_sec_user_audit with (nolock)
where cp_sec_user_audit_id in (
...
WHERE phys_order_id IN (SELECT distinct phys_order_id FROM [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].[dbo].pho_phys_order with (nolock) WHERE fac_id = 1))
AND fac_id <> 1)
and fac_id <> 1
...
where custom_drug_id in (select custom_drug_id from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.cr_cust_med with (nolock) where fac_id in (-1,1))
union
...
sproc_facacq_pre_sec_user_Import_01_scoping - sec_user in pho_phys_order_audit_useraudit4 affected rows
insert into pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1
...
if OBJECT_ID ('pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname','U') is not null
DROP TABLE pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname

if OBJECT_ID ('pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name','U') is not null
DROP TABLE pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name

if OBJECT_ID ('pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name','U') is not null
DROP TABLE pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name

if OBJECT_ID ('dbo.EICase588991sec_user','U') is not null
DROP TABLE dbo.EICase588991sec_user

sproc_facacq_pre_sec_user_Import_02_Import - drop temporary tables


select  a.* into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname
...
sproc_facacq_pre_sec_user_Import_02_Import - pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname - 10 affected rows


insert into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname
select a.*
from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
where a.userid in (select distinct userid from pcc_temp_storage.dbo._bkp_EICase588991_sec_user_import_pre_scoping_fac_1)

sproc_facacq_pre_sec_user_Import_02_Import - pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname - 0 affected rows


select identity(int,1,1) as row_id, src.userid as src_id, NULL as dst_id
into dbo.EICase588991sec_user 
...
SELECT DISTINCT a.dst_id
	,192   
	,src.access_level
FROM dbo.EICase588991sec_user a join [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user_facility src
on a.src_id = src.userid
WHERE src.userid NOT IN (SELECT userid FROM pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_sameloginname) and src.facility_id = 1

sproc_facacq_pre_sec_user_Import_02_Import - sec_user_facility - 566 affected rows


select  a.* into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name
from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user a
join  dbo.sec_user b
on a.loginname = b.loginname
where a.fac_id = 1 
...
sproc_facacq_pre_sec_user_Import_02_Import - pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name - 0 affected rows


insert into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name
select a.*
from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user a
join  dbo.sec_user b
on a.loginname = b.loginname
...
INSERT INTO dbo.sec_user
SELECT map.dst_id,192,'EICase588991',getdate(),'EICase588991',getdate(),'1504962637',[long_username],NULL,[loginname] + 'PRQC',[remote_user],[admin_user],[eadmin_setup_user],[ecare_setup_user],[ecare_user],[eadmin_user],NULL,[default_care_tab],[default_admin_tab],[auto_pagesetup],-1,[enabled],[pho_access],[enterprise_user],[regional_setup_access],[regional_id],NULL,[mds_portal_view],[cms_checked_clinical],[cms_checked_admin],[cms_checked_qia],[cms_checked_glap],[cms_checked_enterprise],[passwd_check],[passwd_expiry_date],[alternate_loginname],[login_to_enterprise_flag],[mmq_portal_view],[uda_portal_view],[max_failed_logins],[designation_desc],[care_line_id],[pharmacy_portal_view],[initials],[REENABLED_DATE],[VALID_UNTIL_DATE],[EXTERNAL_SYSTEM_ID],[EXT_FAC_ID],[pin_check],[login_to_irm],[pin_expiry_date],[all_facilities],[last_login_date],[authentication_method],[next_nps_survey_date],[pharmacy_portal_pharmtab],[user_type_id],NULL,[comment],[user_first_name],[user_last_name],[api_only_user],[default_admin_view],[sso_only_user]
FROM  [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user src 
JOIN dbo.EICase588991sec_user map ON src.userid = map.src_id
and src_id IN (select userid from pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name)
...
FROM dbo.EICase588991sec_user a join [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user_facility src
on a.src_id = src.userid
JOIN pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name t on src.userid = t.userid
WHERE src.userid IN (SELECT userid FROM pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_different_name) 
and src.facility_id = 1

sproc_facacq_pre_sec_user_Import_02_Import - sec_user_facility - 0 affected rows
ALTER TABLE dbo.EICase588991sec_user
add corporate char
sproc_facacq_pre_sec_user_Import_02_Import - add corporate column to dbo.EICase588991sec_user
update dbo.EICase588991sec_user set corporate = 'N' 
sproc_facacq_pre_sec_user_Import_02_Import - update dbo.EICase588991sec_user.corporate - 583 affected rows


	select  a.* into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name
	from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user a
	join  dbo.sec_user b
	on a.loginname = b.loginname
	where a.fac_id = 1 
	and a.loginname not like '%pcc-%' and a.loginname  not like '%wescom%'
	and a.long_username = b.long_username 
	and b.created_by not like '%EICase588991'

	
sproc_facacq_pre_sec_user_Import_02_Import - pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name - 10 affected rows


	insert  into pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name
	select a.*
	from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1029].dbo.sec_user a
	join  dbo.sec_user b
	on a.loginname = b.loginname
...
sproc_facacq_pre_sec_user_Import_02_Import - pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name - 0 affected rows


	update map
	set dst_id = ur.userid, corporate = 'Y'
	FROM dbo.EICase588991sec_user map 
	JOIN pcc_temp_storage.dbo.EICase588991_1504962637_sec_user_samelogin_same_name ln ON ln.userid = map.src_id
	JOIN sec_user ur ON ln.loginname = ur.loginname

	
sproc_facacq_pre_sec_user_Import_02_Import - EICase588991sec_user - 10 affected rows
...
JOIN dbo.EICase588991sec_user b ON b.src_id = src.userid 
where b.corporate = 'N' and b.dst_id not in (select userid from sec_user_physical_id)

sproc_facacq_pre_sec_user_Import_02_Import - sec_user_physical_id - 116 affected rows
...
and (created_by like '%EICase588991'  or userid in (select dst_id from EICase588991sec_user where corporate = 'N'))
and admin_user_type is NULL

sproc_facacq_pre_sec_user_Import_02_Import - api user fix - 0 affected rows

Completion time: 2022-03-17T16:37:54.2080117-04:00
