...
BEGIN
	SET @srcFacID = 2
	SET @dstFacID = 193
	SET @srcServer = '[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_prqc_multi]'
	SET @dstServer = '[pccsql-use2-prod-w22-cli0007.4c4638f8e26f.database.windows.net].[us_dhm_multi]'
