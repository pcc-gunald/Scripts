...
set @srcFacID = '1,2,5'
set @SrcServer = '[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_prqc_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0007.4c4638f8e26f.database.windows.net].[us_dhm_multi]'----change dst server & db name
