DECLARE  @srcFacID VARCHAR(100)		=	5
		,@dstFacID VARCHAR(100)		=	194
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_prqc_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0007.4c4638f8e26f.database.windows.net].[us_dhm_multi]'
