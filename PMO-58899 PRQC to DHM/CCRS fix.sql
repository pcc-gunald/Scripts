...
INSERT INTO test_usei1072.dbo.as_std_pick_list (
	pick_list_id
	,fac_id
	,description
	,std_assess_id
...
SELECT pick_list_id
	...
	,description
	,std_assess_id
FROM pcc_staging_db58899.dbo.as_std_pick_list



select * from pcc_staging_db58899.dbo.as_std_pick_list I
WHERE I.fac_id=-1 and  I.std_assess_id = 3 AND I.pick_list_id >= 0

select pick_list_id  into #temp from pcc_staging_db58899.dbo.as_std_pick_list I
WHERE I.fac_id=-1 and  I.std_assess_id = 3 AND I.pick_list_id >= 0
...
select concat(src_id,',') 
from
(select *
from pcc_staging_db58899.dbo.EICase588991as_std_pick_list
union
select *
from pcc_staging_db58899.dbo.EICase588992as_std_pick_list
union
select *
from pcc_staging_db58899.dbo.EICase588995as_std_pick_list
) t
...
*/
select * from pcc_staging_db58899.dbo.EICase588991067as_std_pick_list
where src_id in (350)
