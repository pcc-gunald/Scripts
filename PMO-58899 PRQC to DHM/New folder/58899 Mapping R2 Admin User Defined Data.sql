/*************************************************
R2 Admin - User Defined Data Mapping

-----------------------SCOPE--------------------------
Data for User Defined Data are found in the user_field_types table.

These picklists can be found on the front end at
EMC > Standards > Financial Mangement > General Setup > User Defined Fields
Facility Level > Billing > Setup > Organization Setup > User Defined Fields


--------------------INSTRUCTIONS------------------------
Fill the following fields and then paste the output to the UserDefinedData tab of the excel file found at 
