/*************************************************
R2 Admin - Upload Categories Mapping

-----------------------SCOPE--------------------------
Data for Upload Categories is found in the upload_categories table.

These picklists can be found on the front end at
EMC > Standards > Financial Mangement > General Setup > Pick Lists > Upload Categories
Facility Level > Billing > Setup > Organization Setup > Pick Lists > Upload Categories


--------------------INSTRUCTIONS------------------------
Fill the following fields and then paste the output to the UploadCategories tab of the excel file found at 
