/*************************************************
R1 Clinical - Clinical Advanced Mapping

-----------------------SCOPE--------------------------
Each of the sections of the clinical advanced mapping are related to the following tables and details of where they can be found on the front end:

Administration records - pho_administration_record
EMC > Standards > Care Mangement > Physician Orders > Picklists > Administration Records (click on "Administration Records", not just dropdown)
Facility Level > Clinical > Setup > Orders > Picklists > Administration Records (click on "Administration Records", not just dropdown)

Order Types - pho_order_types
EMC > Standards > Care Mangement > Physician Orders > Picklists > Order Types (click on "Order Types", not just dropdown)
Facility Level > Clinical > Setup > Orders > Picklists > Order Types (click on "Order Types", not just dropdown)

Progress Note Types - pn_type
EMC > Standards > Care Mangement > Progress Notes > PN Types
Facility Level > Clinical > Setup > Progress Notes > Progress Note Types

Immunizations - cr_std_immunization
EMC > Standards > Care Mangement > ???
Facility Level > Clinical > Setup > Immunizations > Pick Lists

Standard Shifts - cp_std_shift
EMC > Standards > Care Mangement > Care Plan > Standard Shifts
Facility Level > Clinical > Setup > Care Plan > Standard Shifts

Risk Management Picklists - inc_std_pick_list_item

Facility Level > Clinical > Setup > Risk Management > Pick Lists


--------------------INSTRUCTIONS------------------------
Fill the following fields and then paste the output to Clinical Advanced tab of the excel file found at 
PMOXYZ_AdvancedClinicalPicklistMappings_R1.xlsx

1. @srcFacID - comma separated string list of facility ids 
...
set @srcFacID = '1,2,5' -- example: '1,2,3'
set @SrcServer = '[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_prqc_multi]' --example: '[pccsql-use2-prod-w19-cli0012.3055e0bc69f6.database.windows.net].us_elvt_multi'
set @DstServer = '[pccsql-use2-prod-w22-cli0007.4c4638f8e26f.database.windows.net].[us_dhm_multi]' --example: '[pccsql-use2-prod-w28-cli0007.874bf44c721a.database.windows.net].us_swc_multi'
