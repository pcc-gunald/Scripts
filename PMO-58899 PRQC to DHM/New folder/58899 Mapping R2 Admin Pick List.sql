/*************************************************
R2 Admin - Admin Pick List Mapping
...
citize- Citizenship
relat- Contact Relationships
respo- Contact Types
dept- Departments
educa- Education
ethnic- Ethnicity
phofac- External Facility Types
lang- Languages
marit- Marital Status
profe- Medical Professional Types
prefi- Prefix
proctp- Professional Contact Types
prorel- Professional Relations
race- Race
relig- Religions
posit- Staff Positions
suffix- Suffix
admit- To/From Type
rtype- Room Types

These picklists can be found on the front end at
EMC > Standards > Financial Mangement > General Setup > Pick Lists
Facility Level > Billing > Setup > Organization Setup > Pick Lists


--------------------INSTRUCTIONS------------------------
Fill the following fields and then paste the output to the AdminPickList tab of the excel file found at 
