DECLARE  @srcFacID VARCHAR(100)		=	4
		,@dstFacID VARCHAR(100)		=	6
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w30-cli0012.cbafa2b80e84.database.windows.net].[us_wsgc]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w30-cli0015.cbafa2b80e84.database.windows.net].[us_wec_multi]'
