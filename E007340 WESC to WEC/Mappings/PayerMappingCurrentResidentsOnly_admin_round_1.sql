...
BEGIN
	SET @srcFacID = 4
	SET @dstFacID = 6
	SET @srcServer = '[pccsql-use2-prod-w30-cli0012.cbafa2b80e84.database.windows.net].[us_wsgc]'
	SET @dstServer = '[pccsql-use2-prod-w30-cli0015.cbafa2b80e84.database.windows.net].[us_wec_multi]'
