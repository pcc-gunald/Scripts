...
set @CaseNumber = 'EICase007340'--use the root case number, keep the 'EICase'
set @SrcServer = '[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].[test_usei549]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1063]'----change dst server & db name
