...
set @srcFacID = '4'
set @SrcServer = '[pccsql-use2-prod-w30-cli0012.cbafa2b80e84.database.windows.net].[us_wsgc]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w30-cli0015.cbafa2b80e84.database.windows.net].[us_wec_multi]'----change dst server & db name
