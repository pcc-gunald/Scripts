...
BEGIN
	...
	SET @action_codes_mapping_table			= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58951_2_ActionCodes$]'
	SET @status_codes_mapping_table			= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58951_2_StatusCodes$]'
	SET @upload_categories_mapping_table	= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO58951_2_UploadCategories$]'
	SET @room_rate_type_mapping_table		= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58951_2_RoomRateType$]'
	...
	/*------If 'Y', payer mapping is inculuded and with naming convention, on FacAcqMapping: 
			PMO58951_2_EICase5895117_payermapping_fac_17_to_54-----*/
