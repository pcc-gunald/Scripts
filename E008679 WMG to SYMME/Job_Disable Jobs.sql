...
EXEC [dbo].[sproc_EnableDisable_POC_EMAR] 'SYMME','1990345',0 
EXEC [dbo].[sproc_EnableDisable_DBMaintenanceJobs] 'SYMME','1990345',0,'2022-02-09 00:14:00','2022-02-10 00:04:00'
...
From [pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].msdb.dbo.sysjobs as jb
Inner Join [pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].msdb.dbo.sysjobschedules as js on js.job_id = jb.job_id
Inner Join [pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].msdb.dbo.sysschedules as sc on js.schedule_id = sc.schedule_id
...
where jb.name in ('DBA - Maintenance - Indexes') and jb.enabled=1
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(1990345)', 'No Action Taken' ,'Index and Statistics','SYMME','1990345') 

Completion time: 2022-02-09T09:09:20.1481074-05:00
