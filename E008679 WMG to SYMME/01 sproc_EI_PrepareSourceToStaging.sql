...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run, E008679'
	...
	SET @prefix_for_UDA						= 'WMG-'
	SET @prefix_for_Care_Plan_Library		= 'WMG-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'WMG'
