...
set @srcFacID = '14,15'
set @SrcServer = '[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_wmg_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].[us_symme_multi]'----change dst server & db name
