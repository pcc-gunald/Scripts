...
BEGIN
	SET @srcFacID = 15
	SET @dstFacID = 8
	SET @srcServer = '[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_wmg_multi]'
	SET @dstServer = '[pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].[us_symme_multi]'
