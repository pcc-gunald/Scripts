...
set @CaseNumber = 'EICase008679'--use the root case number, keep the 'EICase'
set @SrcServer = '[pccsql-use2-prod-ssv-tscon11.b4ea653240a9.database.windows.net].[test_usei1129]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei1018]'----change dst server & db name
