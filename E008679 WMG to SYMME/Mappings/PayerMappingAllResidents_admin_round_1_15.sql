DECLARE  @srcFacID VARCHAR(100)		=	15
		,@dstFacID VARCHAR(100)		=	8
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w24-cli0019.ce22455c967a.database.windows.net].[us_wmg_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w19-cli0005.3055e0bc69f6.database.windows.net].[us_symme_multi]'
