...
EXEC [dbo].[sproc_EnableDisable_POC_EMAR] 'BSD','1989164',0 
EXEC [dbo].[sproc_EnableDisable_DBMaintenanceJobs] 'BSD','1989164',0,'2022-02-07 00:21:00','2022-02-08 00:04:00'
...
From [pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].msdb.dbo.sysjobs as jb
Inner Join [pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].msdb.dbo.sysjobschedules as js on js.job_id = jb.job_id
Inner Join [pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].msdb.dbo.sysschedules as sc on js.schedule_id = sc.schedule_id
...
where jb.name in ('DBA - Maintenance - Indexes') and jb.enabled=1
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(1989164)', 'No Action Taken' ,'Index and Statistics','BSD','1989164') 

Completion time: 2022-02-07T08:37:14.1543960-05:00
