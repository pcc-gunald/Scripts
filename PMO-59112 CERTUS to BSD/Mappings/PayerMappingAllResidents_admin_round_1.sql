DECLARE  @srcFacID VARCHAR(100)		=	12
		,@dstFacID VARCHAR(100)		=	18
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w30-cli0021.cbafa2b80e84.database.windows.net].[us_certus_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].[us_bsd_multi]'
