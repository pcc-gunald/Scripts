...
set @srcFacID = '12'
set @SrcServer = '[pccsql-use2-prod-w30-cli0021.cbafa2b80e84.database.windows.net].[us_certus_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].[us_bsd_multi]'----change dst server & db name
