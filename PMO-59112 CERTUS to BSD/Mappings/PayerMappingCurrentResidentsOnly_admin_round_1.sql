...
BEGIN
	SET @srcFacID = 12
	SET @dstFacID = 18
	SET @srcServer = '[pccsql-use2-prod-w30-cli0021.cbafa2b80e84.database.windows.net].[us_certus_multi]'
	SET @dstServer = '[pccsql-use2-prod-w22-cli0005.4c4638f8e26f.database.windows.net].[us_bsd_multi]'
