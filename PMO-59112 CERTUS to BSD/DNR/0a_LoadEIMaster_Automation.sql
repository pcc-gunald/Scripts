...
(PMONumber,Completed)
SELECT 
'59112' as PMONumber, --PMO Number
0 as Completed

SELECT SCOPE_IDENTITY()

select * from LoadEIMaster_PMO_Groups where PMONumber like '%59112%'--1720

drop table if exists #temp_fac
create table #temp_fac(caseNo varchar(50),src_id int, dest_id int, id int identity (1,1))

insert into #temp_fac values('59112',12,18)
...
SELECT '1778' as [PMO_Group_Id], --PMO_Group_ID created
...
'pcc_staging_db59112' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
...
'E14,E15,E1,E2,E2a,E3,E4,E5,E6,E7a,E7b,E8,E12a,E12b,E11,E9,E10,E13,E20,E21,E22,E23' as [ModList],
...
select * from LoadEIMaster_Automation where PMO_Number = '59112'
/*
