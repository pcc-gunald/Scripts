...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run PMO 59112'
	...
	SET @prefix_for_UDA						= 'CERTUS-'
	SET @prefix_for_Care_Plan_Library		= 'CERTUS-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'CERTUS'
