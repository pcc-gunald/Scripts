...
(PMONumber,Completed)
SELECT 
'59212' as PMONumber, --PMO Number
0 as Completed

SELECT SCOPE_IDENTITY()

select * from LoadEIMaster_PMO_Groups where PMONumber like '%59212%'--1720

drop table if exists #temp_fac
create table #temp_fac(caseNo varchar(50),src_id int, dest_id int, id int identity (1,1))

insert into #temp_fac values('59212',3,29)
...
SELECT '1803' as [PMO_Group_Id], --PMO_Group_ID created
concat(caseNo,src_id) as [CaseNo],-- Case Number, unique per facility
caseNo as [PMO_number],-- PMO Number
'usei1033' as [SrcOrgCode],-- source
'pcc_staging_db59212' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
...
'E1,E2,E2a,E3,E4,E5,E6,E7a,E7b,E7c,E8,E12a,E12b,E11,E9,E10,E13,E20,E21,E22' as [ModList],
...
select * from LoadEIMaster_Automation where PMO_Number = '59212'
/*
