...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run 59212'

	/*------Mapping Backup Tables, will not be applied if left empty, please do not create table name with single quotes------*/
	SET @action_codes_mapping_table			= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E000618_ActionCodes$]'
	SET @status_codes_mapping_table			= ''--'[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E000618_StatusCodes$]'
	SET @upload_categories_mapping_table	=''-- '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E001053_UploadCateogaries$]'
	SET @room_rate_type_mapping_table		=''-- '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E002100RoomRateType]'
