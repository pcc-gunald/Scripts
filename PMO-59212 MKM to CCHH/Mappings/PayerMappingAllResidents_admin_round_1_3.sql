DECLARE  @srcFacID VARCHAR(100)		=	3
		,@dstFacID VARCHAR(100)		=	29
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w26-cli0016.d9c23db323d7.database.windows.net].[us_mkm_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0021.4c4638f8e26f.database.windows.net].[us_cchh_multi]'
