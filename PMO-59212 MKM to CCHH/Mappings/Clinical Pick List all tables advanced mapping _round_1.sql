...
set @srcFacID = '3'
set @SrcServer = '[pccsql-use2-prod-w26-cli0016.d9c23db323d7.database.windows.net].[us_mkm_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0021.4c4638f8e26f.database.windows.net].[us_cchh_multi]'----change dst server & db name
