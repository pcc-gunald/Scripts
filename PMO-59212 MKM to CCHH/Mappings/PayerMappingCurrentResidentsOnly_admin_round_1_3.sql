...
BEGIN
	SET @srcFacID = 3
	SET @dstFacID = 29
	SET @srcServer = '[pccsql-use2-prod-w26-cli0016.d9c23db323d7.database.windows.net].[us_mkm_multi]'
	SET @dstServer = '[pccsql-use2-prod-w22-cli0021.4c4638f8e26f.database.windows.net].[us_cchh_multi]'
