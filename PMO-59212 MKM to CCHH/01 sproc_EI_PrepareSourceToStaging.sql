...
BEGIN
	...
	SET @EmailrecipientsExt = 'Ashneet.Singh@pointclickcare.com;ajensen@cchhealthcare.com;CMoore@CCHHealthcare.com;Tammi.Irvine@pointclickcare.com;delores.gaskin@pointclickcare.com;Megan.Read@pointclickcare.com;Jason.Boone@pointclickcare.com;TSFacAcqConfig@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59212_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59212_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO59212_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59212_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'MKM-'
	SET @prefix_for_Care_Plan_Library		= 'MKM-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'MKM'
...
--E14: Security Roles, E15: Security Users, E7d: MMQ, E7e: MMA, E16: Alert, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM, E23: Notes
