...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run 59132'

	/*------Mapping Backup Tables, will not be applied if left empty, please do not create table name with single quotes------*/
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO5132_P2_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO5132_P2_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO5132_P2_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO5132_P2_RoomRateType$]'
...
--E7d: MMQ, E7e: MMA, E19a: IRM, E19b: IRM, E21: Results Lab, Radiology
--E7d: MMQ, E7e: MMA, E19a: IRM, E19b: IRM, E21: Results Lab, Radiology