...
@pmo_group_id	= '1763'	------ PMO Group ID
...
select * from [vmuspassvtsjob1.pccprod.local].pcc_temp_storage.dbo._bkp_PMO59013_job_log_staging_to_destination with (nolock)
select * from [vmuspassvtsjob1.pccprod.local].pcc_temp_storage.dbo._bkp_PMO59013_job_log_source_to_staging with (nolock)
*/
