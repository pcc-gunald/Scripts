...
BEGIN
	BEGIN TRY
		...
		SET @EmailrecipientsInt = N'dinesh.gunalapan@pointclickcare.com;TechServicesCustomerMaintenance@pointclickcare.com'
...
--		SET @List = 'RESTORE DATABASE ' + @vStageDBName + ' FROM URL = ''' + @vStagingDBBackupForProdPath + '/' + @List
		...
		BEGIN --Start CurCase
			...
			IF EXISTS(SELECT 1 FROM @LoadEIMaster WHERE (',' + ModList + ',') LIKE '%,E15,%' and RunId = @vCurrentRunId)
				BEGIN SET @SqlCommand = @SqlCommand + 'exec [operational].[sproc_facacq_post_ifSecUserPositionUpdate]'+CHAR(13)+CHAR(10)
...
******************
********************************************************
Restore Staging DB on Destination Server pcc_staging_db59013
********************************************************
*************************************************************************
...
**********************************
*****************************************************************************************************
Case No: 590131 : Execute [operational].[sproc_facacq_createInsertMappingTablesStagingToDestination] on Destination DB
*****************************************************************************************************
*************************************************************************************************
Case No: 590131 : Execute [operational].[sproc_facacq_insertStagingToDestinationOnline] on Destination DB
*************************************************************************************************
*****************************************************************
Case No: 590131 : Insert Into ds_merge_master.dbo.EIHistory
*****************************************************************
********************************************************************
Case No: 590131 : Update Into ds_merge_master.dbo.LoadEIMaster_Automation
********************************************************************
***************************************
Case No: 590131 : Enable Facility
***************************************
************************************************************
Case No: 590131 : Execute PostMergeScriptDst on DestDB
************************************************************
************************************************************
Case No: 590131 : Execute PostMergeScriptDst on DestDB
************************************************************
***********************************************************************
Case No: 590131 : Email Notification Facility Migration Completed
***********************************************************************
*****************************************************************************************************
Case No: 590132 : Execute [operational].[sproc_facacq_createInsertMappingTablesStagingToDestination] on Destination DB
*****************************************************************************************************
*************************************************************************************************
Case No: 590132 : Execute [operational].[sproc_facacq_insertStagingToDestinationOnline] on Destination DB
*************************************************************************************************
*****************************************************************
Case No: 590132 : Insert Into ds_merge_master.dbo.EIHistory
*****************************************************************
********************************************************************
Case No: 590132 : Update Into ds_merge_master.dbo.LoadEIMaster_Automation
********************************************************************
***************************************
Case No: 590132 : Enable Facility
***************************************
************************************************************
Case No: 590132 : Execute PostMergeScriptDst on DestDB
************************************************************
************************************************************
Case No: 590132 : Execute PostMergeScriptDst on DestDB
************************************************************
***********************************************************************
Case No: 590132 : Email Notification Facility Migration Completed
***********************************************************************
**************************************************
...
Completion time: 2022-01-10T10:06:06.2039878-05:00
