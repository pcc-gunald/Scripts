...
set @srcFacID = '29,32'
set @SrcServer = '[pccsql-use2-prod-w26-cli0026.d9c23db323d7.database.windows.net].us_zion_multi'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].us_srz_multi'----change dst server & db name
