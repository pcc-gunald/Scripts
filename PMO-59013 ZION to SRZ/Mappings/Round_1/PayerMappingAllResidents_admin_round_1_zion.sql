DECLARE @srcFacID VARCHAR(100)		=	29 
		,@dstFacID VARCHAR(100)		=	29
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w26-cli0026.d9c23db323d7.database.windows.net].us_zion_multi'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].us_srz_multi'
