...
SELECT src_id, dst_id FROM test_usei1122.dbo.EICase586911as_std_assessment --dest


CREATE TABLE #map_as_ard_planner (src_id INT PRIMARY KEY, dst_id INT NOT NULL)
INSERT INTO #map_as_ard_planner
SELECT src_id, dst_id FROM test_usei1122.dbo.EICase586911as_ard_planner  --dest
