DECLARE  @srcFacID VARCHAR(100)		=	6
		,@dstFacID VARCHAR(100)		=	4
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w25-cli0010.2d62ac5c7643.database.windows.net].[us_ldmk_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w19-cli0009.3055e0bc69f6.database.windows.net].[us_mona_multi]'
