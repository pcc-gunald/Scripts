...
set @CaseNumber = 'EICase08866'--use the root case number, keep the 'EICase'
set @SrcServer = '[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].[test_usei1172]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon06.b4ea653240a9.database.windows.net].[test_usei432]'----change dst server & db name
