...
set @CaseNumber = 'EICase99999'--keep EICase add PMO number
set @SrcServer = '[test_source_server].test_useixx'----change src server & db name
set @DstServer = '[test_destination_server].test_useiyy'----change dst server & db name
