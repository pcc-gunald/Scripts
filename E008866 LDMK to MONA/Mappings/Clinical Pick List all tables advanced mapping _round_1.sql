...
set @srcFacID = '6'
set @SrcServer = '[pccsql-use2-prod-w25-cli0010.2d62ac5c7643.database.windows.net].[us_ldmk_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w19-cli0009.3055e0bc69f6.database.windows.net].[us_mona_multi]'----change dst server & db name
