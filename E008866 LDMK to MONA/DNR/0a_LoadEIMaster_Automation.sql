...
(PMONumber,Completed)
SELECT 
'08866 ' as PMONumber, --PMO Number
0 as Completed

SELECT SCOPE_IDENTITY()

select * from LoadEIMaster_PMO_Groups where PMONumber like '%08866%'--1720

drop table if exists #temp_fac
create table #temp_fac(caseNo varchar(50),src_id int, dest_id int, id int identity (1,1))

insert into #temp_fac values('08866',6,4)
...
SELECT '1811' as [PMO_Group_Id], --PMO_Group_ID created
concat(caseNo,src_id) as [CaseNo],-- Case Number, unique per facility
caseNo as [PMO_number],-- PMO Number
'usei964' as [SrcOrgCode],-- source
'pcc_staging_db08866' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
'usei31' as [DstOrgCode],--destination
'usei31' as [DstOrgCodeProd], --org code of current destination
src_id as [SrcFacID],--
src_id as [StgFacID],--
dest_id as [DstFacID],--
...
'E14,E15,E1,E2,E2a,E3,E4,E5,E6,E7a,E7b,E7c,E8,E12a,E12b,E11,E9,E10,E13,E16,E17,E20,E21,E22,E23' as [ModList],
...
select * from LoadEIMaster_Automation where PMO_Number = '08866'
