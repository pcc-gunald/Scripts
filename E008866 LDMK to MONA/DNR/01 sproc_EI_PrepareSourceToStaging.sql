...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run 008866'
	...
	SET @upload_categories_mapping_table	= ''--''[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E001053_UploadCategories$]'
