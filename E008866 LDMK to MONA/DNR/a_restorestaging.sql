...
USE [master]
DROP DATABASE [pcc_staging_db008866];




-- new from template
RESTORE DATABASE pcc_staging_db008866
...
--truncate table  pcc_staging_db008866.[dbo].MergeLog
use pcc_staging_db008866
...
CREATE OR ALTER PROCEDURE [operational].[sproc_facacq_mergeCopyData] @dbOrig VARCHAR(500)
	,@dbStag VARCHAR(500)
	,@dbDest VARCHAR(500)
	,@fac_idO INTEGER
