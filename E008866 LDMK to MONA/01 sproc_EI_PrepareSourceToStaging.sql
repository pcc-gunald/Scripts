...
BEGIN
	...
	SET @EmailrecipientsExt = 'linda.k@pointclickcare.com;rdingman@monarchcommunities.com;rdecicco@monarchcommunities.com;ddistasio@monarchcommunities.com;mbay@monarchcommunities.com;sblevins@monarchcommunities.com;arringmc@email.uc.edu;Ashlee.Moss@pointclickcare.com;Joyce.Tubbs@pointclickcare.com;shannon.m@pointclickcare.com;Gurdish.Kular@pointclickcare.com;rina.p@pointclickcare.com;nigel.liang@pointclickcare.com;theresa.w@pointclickcare.com;TSFacAcqConfig@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E008866_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E008866_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E008866_UploadCategories$]'
	SET @room_rate_type_mapping_table		='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E008866_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'LDMK-'
	SET @prefix_for_Care_Plan_Library		= 'LDMK-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'LDMK'
...
--E7d: MMQ, E7e: MMA, E18: Trust, E19a: IRM, E19b: IRM
