...
USE [master]
DROP DATABASE IF EXISTS [pcc_staging_db009215];




-- new from template
RESTORE DATABASE [pcc_staging_db009215] 
...
--truncate table  [pcc_staging_db009215].[dbo].MergeLog
use [pcc_staging_db009215]
delete  
--select * 
from [pcc_staging_db009215].[dbo].MergeLog
...
--E7c: Custom UDAs, E7d: MMQ, E7e: MMA, E16: Alert, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM, E23: Notes
