DECLARE  @srcFacID VARCHAR(100)		=	88
		,@dstFacID VARCHAR(100)		=	90
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w21-cli0001.f352397924df.database.windows.net].[us_snhc_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w21-cli0002.f352397924df.database.windows.net].[us_cmshc_multi]'
