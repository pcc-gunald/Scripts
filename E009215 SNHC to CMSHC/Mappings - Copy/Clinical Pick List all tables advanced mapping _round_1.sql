...
set @srcFacID = '48,53,72,87,88'
set @SrcServer = '[pccsql-use2-prod-w21-cli0001.f352397924df.database.windows.net].[us_snhc_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w21-cli0002.f352397924df.database.windows.net].[us_cmshc_multi]'----change dst server & db name
