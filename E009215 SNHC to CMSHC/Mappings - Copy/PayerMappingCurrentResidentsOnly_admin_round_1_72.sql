...
BEGIN
	SET @srcFacID = 72
	SET @dstFacID = 88
	SET @srcServer = '[pccsql-use2-prod-w21-cli0001.f352397924df.database.windows.net].[us_snhc_multi]'
	SET @dstServer = '[pccsql-use2-prod-w21-cli0002.f352397924df.database.windows.net].[us_cmshc_multi]'
