...
set @srcFacID = '1'
set @SrcServer = '[pccsql-use2-prod-w23-cli0020.4ccb146400ac.database.windows.net].[us_acac]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w20-cli0018.3055e0bc69f6.database.windows.net].[us_khg_multi]'----change dst server & db name
