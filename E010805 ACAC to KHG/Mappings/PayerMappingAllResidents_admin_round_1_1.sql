DECLARE  @srcFacID VARCHAR(100)		=	1
		...
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w23-cli0020.4ccb146400ac.database.windows.net].[us_acac]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w20-cli0018.3055e0bc69f6.database.windows.net].[us_khg_multi]'
