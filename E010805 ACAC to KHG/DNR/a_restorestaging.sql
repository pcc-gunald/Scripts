...
USE [master]
DROP DATABASE IF EXISTS [pcc_staging_dbE010805];




-- new from template
RESTORE DATABASE pcc_staging_dbE010805
...
--truncate table  pcc_staging_dbE010805.[dbo].MergeLog
use pcc_staging_dbE010805
