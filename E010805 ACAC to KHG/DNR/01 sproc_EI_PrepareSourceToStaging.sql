...
BEGIN
	...
	SET @vExtEmailSubject = 'This is a Test Run E010805'
	...
	SET @prefix_for_UDA						= 'ACAC-'
	SET @prefix_for_Care_Plan_Library		= 'ACAC-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'ACAC'
		...
		BEGIN
			...
			BEGIN --Start CurCase
				...
				IF LEN(@upload_categories_mapping_table) > 1
					...
					SET @SqlCommand = @SqlCommand + '@dest_database = ''' + @vDestLinkedServer + '.' + @vDestDBName + ''','+CHAR(13)+CHAR(10)
					SET @SqlCommand = @SqlCommand + '@if_exclude_condition = ''Y'''+CHAR(13)+CHAR(10)+CHAR(13)+CHAR(10) END
