...
SELECT src_id, dst_id FROM [test_usei1072].dbo.EICase589101067as_std_assessment

CREATE TABLE #map_as_ard_planner (src_id INT PRIMARY KEY, dst_id INT NOT NULL)
INSERT INTO #map_as_ard_planner
SELECT src_id, dst_id FROM [test_usei1072].dbo.EICase589101067as_ard_planner

INSERT INTO [test_usei1072].dbo.as_ard_adl_keys
(
    ard_planner_id
    , std_assess_id
    , question_key
