...
(PMONumber,Completed)
SELECT 
'58910' as PMONumber, --PMO Number
0 as Completed

SELECT SCOPE_IDENTITY()

select * from LoadEIMaster_PMO_Groups where PMONumber like '%58910%'--1720

drop table if exists #temp_fac
create table #temp_fac(caseNo varchar(50),src_id int, dest_id int, id int identity (1,1))

insert into #temp_fac values('58910',1067,59)
...
SELECT '1746' as [PMO_Group_Id], --PMO_Group_ID created
concat(caseNo,src_id) as [CaseNo],-- Case Number, unique per facility
caseNo as [PMO_number],-- PMO Number
'usei548' as [SrcOrgCode],-- source
'pcc_staging_db58910' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
'usei1072' as [DstOrgCode],--destination
'usei1072' as [DstOrgCodeProd], --org code of current destination
src_id as [SrcFacID],--
src_id as [StgFacID],--
dest_id as [DstFacID],--
...
'E14,E15,E1,E2,E2a,E3,E4,E5,E6,E7a,E7b,E8,E11,E9,E10,E13,E20,E21,E22,' as [ModList],
...
select * from LoadEIMaster_Automation where PMO_Number = '58910'
/*
