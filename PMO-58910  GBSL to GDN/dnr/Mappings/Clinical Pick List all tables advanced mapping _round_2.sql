...
set @srcFacID = '1067'
set @SrcServer = '[pccsql-use2-prod-w26-cli0018.d9c23db323d7.database.windows.net].[us_gbsl_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w25-cli0021.2d62ac5c7643.database.windows.net].[us_gdn_multi]'----change dst server & db name
