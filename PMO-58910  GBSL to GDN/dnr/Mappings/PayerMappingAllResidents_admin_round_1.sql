DECLARE @srcFacID VARCHAR(100)		=	'1067' 
		,@dstFacID VARCHAR(100)		=	'59'
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].[test_usei548]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-ssv-tscon11.b4ea653240a9.database.windows.net].[test_usei1072]'
