...
BEGIN
	SET @srcFacID = '1067';
	SET @dstFacID = '59';
	SET @srcServer = '[pccsql-use2-prod-w26-cli0018.d9c23db323d7.database.windows.net].[us_gbsl_multi]';
	SET @dstServer = '[pccsql-use2-prod-w25-cli0021.2d62ac5c7643.database.windows.net].[us_gdn_multi]';
