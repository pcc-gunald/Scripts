...
SELECT pick_list_id
	...
	,description
	,std_assess_id
FROM pcc_staging_db58910.dbo.as_std_pick_list



select * from pcc_staging_db58910.dbo.as_std_pick_list I
WHERE I.fac_id=-1 and  I.std_assess_id = 3 AND I.pick_list_id >= 0

select pick_list_id  into #temp from pcc_staging_db58910.dbo.as_std_pick_list I
WHERE I.fac_id=-1 and  I.std_assess_id = 3 AND I.pick_list_id >= 0
...
select concat(src_id,',') from pcc_staging_db58910.dbo.EICase589101067as_std_pick_list
...
*/
select * from pcc_staging_db58910.dbo.EICase589101067as_std_pick_list
where src_id in (350)
...
delete 
--select * 
from pcc_staging_db58910.dbo.EICase589101067as_std_pick_list
where dst_id in (select pick_list_id from #temp)
