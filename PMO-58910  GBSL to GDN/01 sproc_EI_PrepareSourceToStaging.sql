...
BEGIN
	...
	SET @EmailrecipientsExt = 'LKatz@GardenHC.com;MWeisz@NorthwoodHCM.com;KCampbell@NorthwoodHCM.com;TSFacAcqConfig@pointclickcare.com;theresa.w@pointclickcare.com;matt.s@pointclickcare.com;Tammi.Irvine@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58910_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58910_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO58910_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58910_RoomRateType$]'
	/*------Medicare A id from payer mapping, this is used in room rate type post update------*/
	SET @Medicare_A_in_destination			= '21056'
	...
	SET @prefix_for_UDA						= 'GBSL-'
	SET @prefix_for_Care_Plan_Library		= 'GBSL-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'GBSL'
...
602	589101067	1067	59	E14: Security Roles, E15: Security Users, E1: Resident Identifier, Contact, E2: Staff, E2a: Medical Professional, E3: External Facility, E4: User Defined Data, E5: Room and Bed, E6: Census, E7a: MDS 2, E7b: MDS 3, E7c: Custom UDAs, E8: Diagnosis, E12a: Custom Care Plan, E12b: Care Plan Copy Library, E11: Immunization, E9: Progress Note, E10: Vital, E13: Phys Orders, E16: Alert, E17: Risk Management, E18: Trust, E20: Upload Files, E21: Results Lab, Radiology, E22: Master Insurance, E23: Notes	E7d: MMQ, E7e: MMA, E19a: IRM, E19b: IRM
...
***********************************************
***************************************************************
Case No: 589101067 : Execute PreMergeScriptSrc on Source DB
***************************************************************
***************************************************************
Case No: 589101067 : Execute PreMergeScriptSrc on Source DB
***************************************************************
********************************************************************
Case No: 589101067 : Execute PreMergeScriptDst on Destination DB
********************************************************************
************************************************************
Case No: 589101067 : Execute PreMergeScript on Staging DB
************************************************************
*******************************************************************
Case No: 589101067 : Source to Staging Step3 and Step4 Execution
*******************************************************************
*************************************************************
Case No: 589101067 : Execute PostMergeScript on Staging DB
*************************************************************
*************************************************************************************************
Case No: 589101067 : Backup Staging DB for TS Team Use Only (In Case):- pcc_staging_db58910
*************************************************************************************************
********************************************
Backup Staging DB :- pcc_staging_db58910
********************************************
*******************************************************
Kickoff Staging to Destination Job :- EI_Prepare_Destination__58910
*******************************************************
**************************************************************
...
Completion time: 2021-12-20T09:40:54.3698463-05:00
