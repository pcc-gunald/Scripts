...
JOIN [pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei9.dbo.sec_user dst ON src.loginname = dst.loginname
...
FROM [pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei1188.dbo.sec_user src
JOIN [pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei9.dbo.sec_user dst ON src.loginname = dst.loginname + 'FVE' 
      AND src.long_username <> dst.long_username 
      --AND src.fac_id in (40) 
