...
set @CaseNumber = 'EICase010798'--use the root case number, keep the 'EICase'
set @SrcServer = '[pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei1188'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei9'----change dst server & db name
