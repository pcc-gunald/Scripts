...
select top 1 *, 'SourceTestVersion' as SourceTestVersion from [pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei1188.dbo.pcc_db_version order by 3 desc
select top 1 *, 'StagingVersion' as StagingVersion from pcc_staging_db010798.dbo.pcc_db_version order by 3 desc
select top 1 *, 'DestinationProductionVersion' as DestinationProductionVersion from [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei23.dbo.pcc_db_version order by 3 desc
select top 1 *, 'DestinationTestVersion' as DestinationTestVersion from [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei23.dbo.pcc_db_version order by 3 desc
