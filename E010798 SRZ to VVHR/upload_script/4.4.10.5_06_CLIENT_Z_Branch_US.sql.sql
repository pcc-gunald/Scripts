...
insert into upload_tracking (script, timestamp, upload) values ('UPLOAD_START',getdate(),'4.4.10.5_06_CLIENT_Z_Branch_US.sql')

GO

insert into upload_tracking(script,timestamp,upload) values ('Z_Branch/99_DML/final_step_exec_generate_metadata_diffs.sql',getdate(),'4.4.10.5_06_CLIENT_Z_Branch_US.sql')
...
insert into upload_tracking (script, timestamp, upload) values ('..\Update db version.sql',getdate(),'SET NOCOUNT ON
GO
...
insert into upload_tracking (script, timestamp, upload) values ('..\Update db version.sql',getdate(),'4.4.10.5_06_CLIENT_Z_Branch_US.sql')
...
values ('4.4.10.5_Z', 'upload_history')
...
insert into upload_tracking (script,timestamp,upload) values ('UPLOAD END',getdate(),'4.4.10.5_06_CLIENT_Z_Branch_US.sql')')
