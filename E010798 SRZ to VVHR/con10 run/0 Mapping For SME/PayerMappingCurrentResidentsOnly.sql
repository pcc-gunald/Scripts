DECLARE @srcFacID VARCHAR(100)		=	'40'
		,@dstFacID VARCHAR(100)		=	'1'
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].us_srz_multi'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w26-pccsql-use2-prod-w31-cli0024.90c2966cd166.database.windows.net].us_nspr_multi'
		
		,@dischargedate VARCHAR(100)=	'''__CURRESDATE__'''
