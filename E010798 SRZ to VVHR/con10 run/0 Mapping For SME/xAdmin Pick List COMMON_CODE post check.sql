...
set @SrcServer = '[pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].test_usei23'----change dst server & db name
