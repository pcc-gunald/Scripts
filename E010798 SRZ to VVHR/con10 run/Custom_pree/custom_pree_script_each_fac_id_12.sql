...
SET CONTEXT_INFO 0xDC1000000;
 ...
 ----Select * from common_code where item_id in (10843,10867,10868,10869)

 ----Select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.common_code
 ----where item_id in (10843,10867,10868,10869)

  update  test_usei984.dbo.common_code
set item_description=item_description+'10'
where item_description='Other Diagnosis'
and item_id=9717


 update  test_usei984.dbo.common_code
set item_description=item_description+'1'
where item_description='Other Diagnosis'
and item_id=10867


update  [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.common_code
set item_description=item_description+'1'
...
and item_id=10867
 ...
 update  test_usei984.dbo.common_code
set item_description=item_description+'2'
where item_description='Other Diagnosis'
and item_id=10868
...
and item_id=10868
 ...
 update  test_usei984.dbo.common_code
set item_description=item_description+'3'
where item_description='Other Diagnosis'
and item_id=10869
...
--Violation of PRIMARY KEY constraint 'as_std_category_audit__categoryId_effectiveDate_PK_CL_IX'. Cannot insert duplicate key in object 'dbo.as_std_category_audit'. The duplicate key value is (298, Jun 28 2018  2:34AM).
--The statement has been terminated.
Delete from as_std_category_audit where category_id  in (392,298)
...
--dited_by_audit_id	created_by_audit_id constrint error on [pho_phys_order_audit_useraudit] table
update [cp_sec_user_audit]

set fac_id =7
where cp_sec_user_audit_id=12459
and userid=39470
and fac_id=6
--------------cp_sec_user_audit_id foreighn key constraint on [pho_order_related_value]
----update [cp_sec_user_audit]

----set fac_id =7
----where cp_sec_user_audit_id in (2232,3921)
----and userid in (43571,59736)
----and fac_id in (6,19)
...
update  test_usei984.[dbo].qlib_pick_list_item
...
IF OBJECT_ID('pcc_temp_storage.dbo._bkp_Case010798_as_std_pick_list1', 'U') IS NOT NULL 
DROP TABLE pcc_temp_storage.dbo._bkp_Case010798_as_std_pick_list1

select * into pcc_temp_storage.dbo._bkp_Case010798_as_std_pick_list1
--select *
...
------       (
------            SELECT COUNT(*)
------            from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.pho_std_order src 
------			join [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.pho_std_order dst on src.template_description = dst.template_description 
...
update src
set src.template_description = 'z'+src.template_description
...
from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.pho_std_order_set src 
join [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.pho_std_order_set dst on src.set_description=dst.set_description 
where src.fac_id in (-1,7,8) 
and (src.status <> dst.status
or dst.fac_id <> -1)  
...
update src
set src.set_description = 'z'+src.set_description 
...
inner join [vmuspassvtsjob1.pccprod.local].[FacAcqMapping].[dbo].[PMO-010798_UploadCategories$] um--mapping table for the project
on src.cat_id = um.srcCatID
inner join [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.upload_categories dst--destination database
...
LEFT JOIN test_usei984.dbo.common_code AS src on src.item_id = a.src_item_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.common_code AS dst on dst.item_id = b.dst_item_id
WHERE 
	(
...
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.id_type AS src on src.id_type_id = a.srcIdTypeId
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.id_type AS dst on dst.id_type_id = b.dstIdTypeId
...
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.user_field_types AS src on src.field_type_id = a.srcFieldTypeId
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.user_field_types AS dst on dst.field_type_id = b.dstFieldTypeId
WHERE  a.srcFieldName IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dst_typeid IS NOT NULL --total count of mapping provided by implementer  
...
----------select * from  [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalPicklist$'] 
UPDATE src
SET src.item_description = dst.item_description
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'pho_administration_record'
----administration_record_type_id	description	short_description
--		--E							S			S

--Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$']
...
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.pho_administration_record AS src on src.administration_record_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.pho_administration_record AS dst on dst.administration_record_id = b.dst_id
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'pho_order_type'
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] a
LEFT JOIN [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] b ON a.Map_DstItemId = b.dst_id
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.pho_order_type AS src on src.order_type_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.pho_order_type AS dst on dst.order_type_id = b.dst_id
WHERE  a.src_desc IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dstitemid IS NOT NULL --total count of mapping provided by implementer  
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'pn_type'
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] a
LEFT JOIN [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] b ON a.Map_DstItemId = b.dst_id
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.pn_type AS src on src.pn_type_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.pn_type AS dst on dst.pn_type_id = b.dst_id
WHERE  a.src_desc IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dstitemid IS NOT NULL --total count of mapping provided by implementer  
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'cr_std_immunization'
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] a
LEFT JOIN [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] b ON a.Map_DstItemId = b.dst_id
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.cr_std_immunization AS src on src.std_immunization_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.cr_std_immunization AS dst on dst.std_immunization_id = b.dst_id
WHERE  a.src_desc IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dstitemid IS NOT NULL --total count of mapping provided by implementer  
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'cp_std_shift'
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] a
LEFT JOIN [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] b ON a.Map_DstItemId = b.dst_id
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.cp_std_shift AS src on src.std_shift_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.cp_std_shift AS dst on dst.std_shift_id = b.dst_id
WHERE  a.src_desc IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dstitemid IS NOT NULL --total count of mapping provided by implementer  
...
----select * from [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.mergeTablesmaster where tablename = 'inc_std_pick_list_item'
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] a
LEFT JOIN [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.['PMO-010798_ClinicalAdvanced$'] b ON a.Map_DstItemId = b.dst_id
LEFT JOIN [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei984.dbo.inc_std_pick_list_item AS src on src.pick_list_item_id = a.src_id
LEFT JOIN [pccsql-use2-prod-w20-cli0017.3055e0bc69f6.database.windows.net].us_vvhr.dbo.inc_std_pick_list_item AS dst on dst.pick_list_item_id = b.dst_id
WHERE  a.src_desc IS NOT NULL -- total mapping provided by analyst to implementer    
AND a.map_dstitemid IS NOT NULL --total count of mapping provided by implementer  
