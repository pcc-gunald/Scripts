...
BEGIN
	BEGIN TRY
		...
		SET @EmailrecipientsInt = 'palvinder.singh@pointclickcare.com;techservicescustomermaintenance@pointclickcare.com;'
		/*------Internal Email Notification Subject, will use default if left empty------*/
		SET @vIntEmailSubject = 'Friendly Reminder Email:E010798 Location Acquisition SRZ to VVHR'
...
******************
********************************************************
Restore Staging DB on Destination Server pcc_staging_db010798
********************************************************
*************************************************************************
...
**********************************
*****************************************************************************************************
Case No: 01079812 : Execute [operational].[sproc_facacq_createInsertMappingTablesStagingToDestination] on Destination DB
*****************************************************************************************************
*************************************************************************************************
Case No: 01079812 : Execute [operational].[sproc_facacq_insertStagingToDestinationOnline] on Destination DB
*************************************************************************************************
*****************************************************************
Case No: 01079812 : Insert Into ds_merge_master.dbo.EIHistory
*****************************************************************
********************************************************************
Case No: 01079812 : Update Into ds_merge_master.dbo.LoadEIMaster_Automation
********************************************************************
***************************************
Case No: 01079812 : Enable Facility
***************************************
************************************************************
Case No: 01079812 : Execute PostMergeScriptDst on DestDB
************************************************************
************************************************************
Case No: 01079812 : Execute PostMergeScriptDst on DestDB
************************************************************
***********************************************************************
Case No: 01079812 : Email Notification Facility Migration Completed
***********************************************************************
*****************************************************************************************************
Case No: 01079813 : Execute [operational].[sproc_facacq_createInsertMappingTablesStagingToDestination] on Destination DB
*****************************************************************************************************
*************************************************************************************************
Case No: 01079813 : Execute [operational].[sproc_facacq_insertStagingToDestinationOnline] on Destination DB
*************************************************************************************************
*****************************************************************
Case No: 01079813 : Insert Into ds_merge_master.dbo.EIHistory
*****************************************************************
********************************************************************
Case No: 01079813 : Update Into ds_merge_master.dbo.LoadEIMaster_Automation
********************************************************************
***************************************
Case No: 01079813 : Enable Facility
***************************************
************************************************************
Case No: 01079813 : Execute PostMergeScriptDst on DestDB
************************************************************
************************************************************
Case No: 01079813 : Execute PostMergeScriptDst on DestDB
************************************************************
***********************************************************************
Case No: 01079813 : Email Notification Facility Migration Completed
***********************************************************************
**************************************************
...
Completion time: 2022-04-13T00:14:34.6161042-04:00
