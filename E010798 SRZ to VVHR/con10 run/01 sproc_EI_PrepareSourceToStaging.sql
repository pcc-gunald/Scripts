...
BEGIN
	...
	Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.PMO010798_EICase01079812_payermapping_fac_7_to_12
	Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.PMO010798_EICase01079813_payermapping_fac_8_to_13
	 

	Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO010798_RoomRateType$]
	Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO010798_StatusCodes$]
	Select * from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO010798_ActionCodes$]
Source_DB_Version
test_usei984 - DB Version: 4.4.11_A                                                                       

Staging_DB_Version
pcc_staging_db010798 - DB Version: 4.4.11_A                                                                          
Destination_DB_Version
us_vvhr - DB Version: 4.4.11_A                                          
...
906	01079812	7	N	E010798-Meadow View of Harrisonville Health and Rehab - Harrisonville, MO -	2203 E Mechanic Street	12	N	Meadow View of Harrisonville Health and Rehab - Harrisonville, MO - SNF	2203 E Mechanic Street	E14: Security Roles, E15: Security Users, E1: Resident Identifier, Contact, E2: Staff, E2a: Medical Professional, E3: External Facility, E4: User Defined Data, E5: Room and Bed, E6: Census, E7a: MDS 2, E7b: MDS 3, E7c: Custom UDAs, E8: Diagnosis, E12b: Care Plan Copy Library, E11: Immunization, E9: Progress Note, E10: Vital, E13: Phys Orders, E16: Alert, E20: Upload Files, E21: Results Lab, Radiology, E22: Master Insurance, E23: Notes	E7d: MMQ, E7e: MMA, E12a: Custom Care Plan, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM
907	01079813	8	N	E010798-Riverbend Heights Health & Rehabilitation - Lexington, MO- SNF	1221 Highway 13 South	13	N	Riverbend Heights Health & Rehabilitation - Lexington, MO- SNF	221 Highway 13 South	E14: Security Roles, E15: Security Users, E1: Resident Identifier, Contact, E2: Staff, E2a: Medical Professional, E3: External Facility, E4: User Defined Data, E5: Room and Bed, E6: Census, E7a: MDS 2, E7b: MDS 3, E7c: Custom UDAs, E8: Diagnosis, E12b: Care Plan Copy Library, E11: Immunization, E9: Progress Note, E10: Vital, E13: Phys Orders, E16: Alert, E20: Upload Files, E21: Results Lab, Radiology, E22: Master Insurance, E23: Notes	E7d: MMQ, E7e: MMA, E12a: Custom Care Plan, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM
*/

	/*------PMO Group ID, make sure the PMO Number set up is unique------*/
	SET @vPMOGroupID = 1855
	...
	SET @EmailrecipientsExt = 'linda.k@pointclickcare.com;janderson@valleyviewmo.com;chaim@beaconhcg.com;jthompson@summationfs.com;tirvine@summationfs.com;stephani.kish@pointclickcare.com;wendy.panganiban@pointclickcare.com;sharilyn.allen@pointclickcare.com;machelle.wood@pointclickcare.com;theresa.w@pointclickcare.com;tsfacacqconfig@pointclickcare.com;palvinder.singh@pointclickcare.com;'
	/*------External Email Notification Subject, for start of the run, will use default if left empty------*/
	SET @vExtEmailSubject = 'Friendly Reminder Email:E010798 Location Acquisition SRZ to VVHR'
	...
	SET @prefix_for_UDA						= 'SRZ-'
	SET @prefix_for_Care_Plan_Library		= 'SRZ-'
	SET @CP_Library_to_exclude_from_prefix	= ''
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'SRZ'
