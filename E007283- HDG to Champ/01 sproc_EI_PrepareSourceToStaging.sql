...
BEGIN
	...
	SET @EmailrecipientsExt = 'Laurie.Watkins@pointclickcare.com;melodee.mercado@pointclickcare.com;efink@champbusiness.com;m.cannon@championhcare.com;Ali.Moosa@pointclickcare.com;stephani.kish@pointclickcare.com;Sydney.Barill@pointclickcare.com;TSFacAcqConfig@pointclickcare.com;Alexander.Morcet@pointclickcare.com;Jennifer.Hundekar@pointclickcare.com'
	...
	SET @action_codes_mapping_table			='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_UploadCategories$]'
	SET @room_rate_type_mapping_table		='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_RoomRateType$]'
	/*------Medicare A id from payer mapping, this is used in room rate type post update------*/--mccorc@pointclickcarecloud.com
	SET @Medicare_A_in_destination			= '4'

	/*------If 'Y', payer mapping is inculuded and with naming convention, on FacAcqMapping: 
	PMO007283_EICase0072832_payermapping_fac_2_to_50
			PMO[PMO_NUMBER]_EICase[CASE_NUMBER]_payermapping_fac_[SRC_FAC_ID]_to_[DST_FAC_ID]-----*/
	SET @if_include_payer_mapping			= 'Y'

	SET @prefix_for_UDA						= 'HDG-'
	SET @prefix_for_Care_Plan_Library		= 'HDG-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'HDG'

	/*------For AUTO-PRE, to filer pick_list_id for CCRS issue, comma separated-----*/
	SET @csv_pick_list_ids					= '-70,300,301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328,329,330,331,332,333,334,335,336,337,338,340,342,344,345,346,348,349,351,352,353,354,355,360,361,362,363,364,365,366,367,713,714,1000845,1007531,1007532,1007533,1007534'
