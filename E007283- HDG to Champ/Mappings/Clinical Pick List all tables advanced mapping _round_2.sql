...
set @srcFacID = '2'
set @SrcServer = '[pccsql-use2-prod-w25-cli0023.2d62ac5c7643.database.windows.net].us_hdg_multi'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w28-cli0007.874bf44c721a.database.windows.net].us_champ_multi'----change dst server & db name
