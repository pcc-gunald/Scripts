DECLARE @srcFacID VARCHAR(100)		=	'2' 
		,@dstFacID VARCHAR(100)		=	'50'
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].test_usei547'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei1062'
