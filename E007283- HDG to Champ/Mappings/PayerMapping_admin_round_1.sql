...
--pccsql-use2-prod-w28-cli0007.874bf44c721a.database.windows.net  us_champ_multi
--pccsql-use2-prod-w25-cli0023.2d62ac5c7643.database.windows.net us_hdg_multi
...
BEGIN
	SET @srcFacID = '2';
	SET @dstFacID = '50';
	SET @srcServer = '[pccsql-use2-prod-w25-cli0023.2d62ac5c7643.database.windows.net].us_hdg_multi';
	SET @dstServer = '[pccsql-use2-prod-w28-cli0007.874bf44c721a.database.windows.net].us_champ_multi';
