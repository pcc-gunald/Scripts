...
BEGIN
	SET @srcFacID = '2';
	SET @dstFacID = '50';
	SET @srcServer = '[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].test_usei547';
	SET @dstServer = '[pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].test_usei1062'
	SET @dischargedate = '''2020-05-01 00:00:00'''
