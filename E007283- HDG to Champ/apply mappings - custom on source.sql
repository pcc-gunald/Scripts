...
LEFT JOIN test_usei87.dbo.common_code AS src on src.item_id = a.src_item_id
...
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.id_type AS src on src.id_type_id = a.srcIdTypeId
...
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.user_field_types AS src on src.field_type_id = a.srcFieldTypeId
...
JOIN test_usei87.dbo.common_code AS src on src.item_id = a.src_item_id
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.pho_administration_record AS src on src.administration_record_id = a.src_id
...
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.pho_order_type AS src on src.order_type_id = a.src_id
...
--SELECT distinct a.src_id, a.Map_DstItemId, src.description , dst.description
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.pn_type AS src on src.pn_type_id = a.src_id
...
--SELECT distinct a.src_id, a.Map_DstItemId, src.description , dst.description, src.short_description, dst.short_description
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.cr_std_immunization AS src on src.std_immunization_id = a.src_id
...
--SELECT distinct a.src_id, a.Map_DstItemId, src.description , dst.description
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.cp_std_shift AS src on src.std_shift_id = a.src_id
...
--SELECT distinct a.src_id, a.Map_DstItemId, src.description , dst.description
from [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007283_Clinical_Advanced$] a
JOIN [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].test_usei87.dbo.inc_std_pick_list_item AS src on src.pick_list_item_id = a.src_id
