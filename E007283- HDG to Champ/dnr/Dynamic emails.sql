...
BEGIN
	...
	DECLARE @pmo_number VARCHAR(MAX) = 'E007283'

	DECLARE @src_org_code VARCHAR(MAX) = 'HDG'
	DECLARE @dst_org_code VARCHAR(MAX) = 'CHAMP'

	DECLARE @src_prod VARCHAR(MAX) = '[pccsql-use2-prod-w25-cli0023.2d62ac5c7643.database.windows.net].[us_hdg_multi]i'
	...
	DECLARE @implementers varchar(200) = 'Wendy & Lucy'
