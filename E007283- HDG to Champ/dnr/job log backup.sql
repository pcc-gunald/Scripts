...
@pmo_group_id	= '1605'	------ PMO Group ID
...
select * from [vmuspassvtsjob1.pccprod.local].pcc_temp_storage.dbo._bkp_PMO005318_job_log_staging_to_destination with (nolock)
select * from [vmuspassvtsjob1.pccprod.local].pcc_temp_storage.dbo._bkp_PMO005318_job_log_source_to_staging with (nolock)
*/
