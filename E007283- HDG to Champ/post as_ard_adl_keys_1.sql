...
SELECT src_id, dst_id FROM test_usei1062.dbo.EICase0072832as_std_assessment

CREATE TABLE #map_as_ard_planner (src_id INT PRIMARY KEY, dst_id INT NOT NULL)
INSERT INTO #map_as_ard_planner
SELECT src_id, dst_id FROM test_usei1062.dbo.EICase0072832as_ard_planner

INSERT INTO test_usei1062.dbo.as_ard_adl_keys
(
    ard_planner_id
    , std_assess_id
    , question_key
...
SELECT DISTINCT 
    ...
    , [resp_value]
    , [source_id]
FROM [pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].[test_usei547].dbo.as_ard_adl_keys a
