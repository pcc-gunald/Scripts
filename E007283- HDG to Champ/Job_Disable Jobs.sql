...
EXEC [dbo].[sproc_EnableDisable_POC_EMAR] 'CHAMP','1977186',0 
EXEC [dbo].[sproc_EnableDisable_DBMaintenanceJobs] 'CHAMP','1977186',0,'2022-01-19 13:00:00','2022-01-19 23:00:00'
...
/* 
 ...
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(1977186)', '' ,'POC and EMAR Backup','CHAMP','1977186') 
...
where jb.name in ('DBA - Maintenance - Indexes') and jb.enabled=1
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(1977186)', 'No Action Taken' ,'Index and Statistics','CHAMP','1977186') 

Completion time: 2022-01-19T08:13:53.6834118-05:00
