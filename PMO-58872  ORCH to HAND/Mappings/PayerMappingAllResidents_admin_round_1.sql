DECLARE @srcFacID VARCHAR(100)		=	6 
		,@dstFacID VARCHAR(100)		=	68
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w27-cli0023.851c37dfbe45.database.windows.net].[us_orch_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w24-cli0023.ce22455c967a.database.windows.net].[us_hand_multi]'
