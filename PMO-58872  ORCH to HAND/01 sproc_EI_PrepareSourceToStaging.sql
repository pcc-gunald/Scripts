...
BEGIN
	...
	SET @EmailrecipientsExt = 'Melissa.Hughes@pointclickcare.com;stephani.kish@pointclickcare.com;Tammi.Irvine@pointclickcare.com;melodee.mercado@pointclickcare.com;Veena.Chahl@pointclickcare.com;TSFacAcqConfig@pointclickcare.com;adecker@embassyhealthcare.net'
	...
	SET @action_codes_mapping_table			=' [vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58872_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58872_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO58872_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO58872_RoomRateType$]'
	/*------Medicare A id from payer mapping, this is used in room rate type post update------*/--mccorc@pointclickcarecloud.com
	SET @Medicare_A_in_destination			= '197'
	...
	SET @prefix_for_UDA						= 'ORCH-'
	SET @prefix_for_Care_Plan_Library		= 'ORCH-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'ORCH'
