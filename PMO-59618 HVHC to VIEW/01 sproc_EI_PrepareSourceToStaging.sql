...
BEGIN
	...
	SET @EmailrecipientsExt = 'Barbara.Day@pointclickcare.com;Shannon.Mansfield@pointclickcare.com;stephani.kish@pointclickcare.com;Raju.Sivapalan@pointclickcare.com;ckelly@southcountynursing.com;masiedu@southcountynursing.com;kgobin@southcountynursing.com;lgalligan@southcountynursing.com;mlawrence@southcountynursing.com;npetrarca@southcountynursing.com;myoung@southcountynursing.com;wayres@southcountynursing.com;juhernandez@southcountrynursing.com;cpalardy@southcountynursing.com;rmccormick@southcountynursing.com'
	...
	SET @action_codes_mapping_table			='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59618_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59618_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO59618_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59618_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'HVHC'
	SET @prefix_for_Care_Plan_Library		= 'HVHC-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'HVHC'
