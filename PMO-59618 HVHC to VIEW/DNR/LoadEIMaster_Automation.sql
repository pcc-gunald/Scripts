    ...
    'pcc_staging_db59618' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
    'USEI45' as [DstOrgCode],--destination
    'USEI45' as [DstOrgCodeProd], --org code of current destination
    src_id as [SrcFacID],--
    src_id as [StgFacID],--
    dest_id as [DstFacID],--
