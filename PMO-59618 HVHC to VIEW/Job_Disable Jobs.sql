...
EXEC [dbo].[sproc_EnableDisable_POC_EMAR] 'VIEW','2003522',0 
EXEC [dbo].[sproc_EnableDisable_DBMaintenanceJobs] 'VIEW','2003522',0,'2022-04-13 21:00:00','2022-04-14 00:04:00'
...
From [pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].msdb.dbo.sysjobs as jb
Inner Join [pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].msdb.dbo.sysjobschedules as js on js.job_id = jb.job_id
Inner Join [pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].msdb.dbo.sysschedules as sc on js.schedule_id = sc.schedule_id
...
where jb.name in ('DBA - Maintenance - Indexes') and jb.enabled=1
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(2003522)', 'No Action Taken' ,'Index and Statistics','VIEW','2003522') 

Completion time: 2022-04-13T09:41:20.3305402-04:00
