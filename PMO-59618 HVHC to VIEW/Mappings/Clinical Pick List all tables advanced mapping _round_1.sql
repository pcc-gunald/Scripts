...
set @srcFacID = '4'
set @SrcServer = '[pccsql-use2-prod-w26-cli0003.d9c23db323d7.database.windows.net].[us_hvhc_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].[us_view]'----change dst server & db name
