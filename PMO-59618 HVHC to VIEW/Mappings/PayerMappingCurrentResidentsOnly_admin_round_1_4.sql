...
BEGIN
	SET @srcFacID = 4
	SET @dstFacID = 2
	SET @srcServer = '[pccsql-use2-prod-w26-cli0003.d9c23db323d7.database.windows.net].[us_hvhc_multi]'
	SET @dstServer = '[pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].[us_view]'
