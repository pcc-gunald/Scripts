DECLARE  @srcFacID VARCHAR(100)		=	4
		,@dstFacID VARCHAR(100)		=	2
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w26-cli0003.d9c23db323d7.database.windows.net].[us_hvhc_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w27-cli0027.851c37dfbe45.database.windows.net].[us_view]'
