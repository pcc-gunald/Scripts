...
BEGIN
	...
	SET @EmailrecipientsExt = 'Stephani Kish <stephani.kish@pointclickcare.com>; Joyce Tubbs <Joyce.Tubbs@pointclickcare.com>; Stefanie Tuck <Stefanie.Tuck@pointclickcare.com>; Linna Polley <Linna.Polley@pointclickcare.com>; Rina Perez <rina.p@pointclickcare.com>; Nigel Liang <nigel.liang@pointclickcare.com>; Theresa Wojtkiewicz <theresa.w@pointclickcare.com>; TS Fac Acq Configuration <TSFacAcqConfig@pointclickcare.com>; Alexander Morcet <Alexander.Morcet@pointclickcare.com>;me.woodward@tranquilitymgt.com; david.melton@tranquilitymgt.com;Linda Kim <linda.k@pointclickcare.com>'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E009632_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E009632_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E009632_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E009632_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'HHI-'
	SET @prefix_for_Care_Plan_Library		= 'HHI-'
	SET @CP_Library_to_exclude_from_prefix	= ''
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'HHI'
	...
	IF @vProdRun = 'Y'
	BEGIN
		SET @vPagerDutyOperator = 'TS10'
		SET @vPagerDutyEmail = @vPagerDutyOperator + '@pccs.pagerduty.com'
	END
	ELSE
	BEGIN
