...
set @CaseNumber = 'EICase009632'--keep EICase add PMO number
set @SrcServer = '[pccsql-use2-prod-ssv-tscon06.b4ea653240a9.database.windows.net].test_usei435'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon05.b4ea653240a9.database.windows.net].test_usei425'----change dst server & db name
