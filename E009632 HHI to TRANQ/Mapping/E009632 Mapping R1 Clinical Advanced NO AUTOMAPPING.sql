...
set @srcFacID = '20,21'
set @SrcServer = '[pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w20-cli0009.3055e0bc69f6.database.windows.net].us_tranq_multi'----change dst server & db name
...
/*
select * from [pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi.dbo.pho_administration_record a
left JOIN [pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi.dbo.common_code b ON a.administration_record_type_id = b.item_id
where a.deleted = 'N'
and a.fac_id in(-1, 20,21)
...
FROM [pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi.dbo.pho_administration_record a 
JOIN [pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi.dbo.common_code b ON a.administration_record_type_id = b.item_id
WHERE a.deleted = 'N'
and (a.fac_id in (-1, 20,21) or a.reg_id in (select regional_id from  [pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi.dbo.facility where fac_id in (20,21)))
