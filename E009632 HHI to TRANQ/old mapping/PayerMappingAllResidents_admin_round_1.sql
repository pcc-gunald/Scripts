DECLARE @srcFacID VARCHAR(100)		=	21
		,@dstFacID VARCHAR(100)		=	16
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w26-cli0028.d9c23db323d7.database.windows.net].us_hhi_multi'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w20-cli0009.3055e0bc69f6.database.windows.net].us_tranq_multi'
