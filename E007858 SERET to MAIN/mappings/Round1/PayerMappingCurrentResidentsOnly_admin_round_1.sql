...
BEGIN
	SET @srcFacID = 2
	SET @dstFacID = 16
	SET @srcServer = '[pccsql-use2-prod-w19-cli0006.3055e0bc69f6.database.windows.net].[us_seret_multi]'
	SET @dstServer = '[pccsql-use2-prod-w25-cli0022.2d62ac5c7643.database.windows.net].[us_main_multi]'
