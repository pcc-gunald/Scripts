...
EXEC [dbo].[sproc_EnableDisable_POC_EMAR] 'MAIN','1991291',0 
EXEC [dbo].[sproc_EnableDisable_DBMaintenanceJobs] 'MAIN','1991291',0,'2022-01-27 15:00:00','2022-01-27 23:00:00'
...
From [pccsql-use2-prod-w25-cli0022.2d62ac5c7643.database.windows.net].msdb.dbo.sysjobs as jb
Inner Join [pccsql-use2-prod-w25-cli0022.2d62ac5c7643.database.windows.net].msdb.dbo.sysjobschedules as js on js.job_id = jb.job_id
Inner Join [pccsql-use2-prod-w25-cli0022.2d62ac5c7643.database.windows.net].msdb.dbo.sysschedules as sc on js.schedule_id = sc.schedule_id
...
where jb.name in ('DBA - Maintenance - Indexes') and jb.enabled=1
 INSERT INTO [vmuspassvjob001.pccprod.local].[dba_admin].dbo.dba_task_audit (audit_date, username,audit_text,scheduler,org_code,case_number) 
					VALUES (getdate(),'PCCPROD\gunald(1991291)', 'No Action Taken' ,'Index and Statistics','MAIN','1991291') 

Completion time: 2022-01-27T09:43:08.1616854-05:00
