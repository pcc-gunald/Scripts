...
BEGIN
	...
	SET @EmailrecipientsExt = 'chantel.m@pointclickcare.com;Catherine.Kimble@sunabellaseniorliving.com;Julie.Ozley@mainstayseniorliving.com;joseph.cassiba@mainstayseniorliving.com;eileen.mayo@mainstayseniorliving.com; Cynthia.garnto@sunabellaseniorliving.co;TSFacAcqConfig@pointclickcare.com;Tammi.Irvine@pointclickcare.com;Raju.Sivapalan@pointclickcare.com;Lori.Benedict@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007858_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007858_StatusCodes$]'
	SET @upload_categories_mapping_table	='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E007858_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E007858_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'SERET-'
	SET @prefix_for_Care_Plan_Library		= 'SERET-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'SERET'
