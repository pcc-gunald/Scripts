    ...
    'USEI963' as [SrcOrgCode],-- source
    'pcc_staging_db010189' as  [STgOrgCode], --staging DB, same for all facilities within one PMO
    'USEI46' as [DstOrgCode],--destination
    'USEI46' as [DstOrgCodeProd], --org code of current destination
    src_id as [SrcFacID],--
    src_id as [StgFacID],--
    dest_id as [DstFacID],--
