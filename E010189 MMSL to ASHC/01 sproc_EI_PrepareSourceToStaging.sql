...
BEGIN
	...
	SET @EmailrecipientsExt = 'linda.k@pointclickcare.com;DConnolly@aspenhealth.com;TeisiU@aspenhealth.com;EColumna@aspenhealth.com;Cherryj@aspenhealth.com;averym@aspenhealth.com;SAnderson@aspenhealth.com;Tiffany.Rhoads@pointclickcare.com;Ashlee.Moss@pointclickcare.com;Wendy.Panganiban@pointclickcare.com;Megan.Read@pointclickcare.com;rina.p@pointclickcare.com;nigel.liang@pointclickcare.com;theresa.w@pointclickcare.com;TSFacAcqConfig@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E010189_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E010189_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[E010189_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[E010189_RoomRateType$]'
	...
	SET @prefix_for_UDA						= 'MMSL-'
	SET @prefix_for_Care_Plan_Library		= 'MMSL-'
	SET @CP_Library_to_exclude_from_prefix	= '8,9'
	SET @suffix_for_order_libraries			= '_'
	SET @suffix_for_sec_user_loginname		= 'MMSL'
...
--E7d: MMQ, E7e: MMA, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM, E21: Results Lab, Radiology, E23: Notes
--E7d: MMQ, E7e: MMA, E17: Risk Management, E18: Trust, E19a: IRM, E19b: IRM, E21: Results Lab, Radiology, E23: Notes
