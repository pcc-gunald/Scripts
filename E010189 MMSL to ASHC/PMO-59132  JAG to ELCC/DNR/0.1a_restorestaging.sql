...
USE [master]
DROP DATABASE [pcc_staging_db59132_P2];




-- new from template
RESTORE DATABASE pcc_staging_db59132_P2 
...
--truncate table  pcc_staging_db59132_P2.[dbo].MergeLog
use pcc_staging_db59132_P2
