...
BEGIN
	SET @srcFacID = 8
	SET @dstFacID = 34
	SET @srcServer = '[pccsql-use2-prod-w25-cli0017.2d62ac5c7643.database.windows.net].[us_jag_multi]'
	SET @dstServer = '[pccsql-use2-prod-w20-cli0007.3055e0bc69f6.database.windows.net].[us_elcc_multi]'
