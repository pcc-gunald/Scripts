...
set @srcFacID = '8'
set @SrcServer = '[pccsql-use2-prod-w25-cli0017.2d62ac5c7643.database.windows.net].[us_jag_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w20-cli0007.3055e0bc69f6.database.windows.net].[us_elcc_multi]'----change dst server & db name
