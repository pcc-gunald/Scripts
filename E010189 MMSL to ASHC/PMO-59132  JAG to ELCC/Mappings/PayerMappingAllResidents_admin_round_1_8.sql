DECLARE  @srcFacID VARCHAR(100)		=	8
		,@dstFacID VARCHAR(100)		=	34
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w25-cli0017.2d62ac5c7643.database.windows.net].[us_jag_multi]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w20-cli0007.3055e0bc69f6.database.windows.net].[us_elcc_multi]'
