...
--select *
--from [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei963].dbo.upload_categories src with (nolock)
--join #tempmappingdistinct map with (nolock) on src.Cat_Id = map.src_id
--join [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].[test_usei46].dbo.upload_categories dst with (nolock) on dst.Cat_Id = map.dst_id
--left join [pccsql-use2-prod-ssv-tscon10.b4ea653240a9.database.windows.net].[test_usei963].dbo.regions regs on regs.regional_id = src.reg_id
--left join [pccsql-use2-prod-ssv-tscon13.b4ea653240a9.database.windows.net].[test_usei46].dbo.regions regd on regd.regional_id = dst.reg_id
--where src.deleted <> 'Y'