...
set @srcFacID = '11'
set @SrcServer = '[pccsql-use2-prod-w26-cli0006.d9c23db323d7.database.windows.net].[us_mmsl_multi]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0013.4c4638f8e26f.database.windows.net].[us_ashc_multi]'----change dst server & db name
