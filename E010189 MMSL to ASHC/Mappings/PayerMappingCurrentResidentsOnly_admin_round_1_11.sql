...
BEGIN
	SET @srcFacID = 11
	SET @dstFacID = 35
	SET @srcServer = '[pccsql-use2-prod-w26-cli0006.d9c23db323d7.database.windows.net].[us_mmsl_multi]'
	SET @dstServer = '[pccsql-use2-prod-w22-cli0013.4c4638f8e26f.database.windows.net].[us_ashc_multi]'
