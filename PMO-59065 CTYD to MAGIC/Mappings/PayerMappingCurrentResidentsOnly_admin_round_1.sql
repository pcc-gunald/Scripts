...
BEGIN
	SET @srcFacID = 1
	SET @dstFacID = 39
	SET @srcServer = '[pccsql-use2-prod-w24-cli0014.ce22455c967a.database.windows.net].[us_ctyd]'
	SET @dstServer = '[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].[us_magic_multi]'
