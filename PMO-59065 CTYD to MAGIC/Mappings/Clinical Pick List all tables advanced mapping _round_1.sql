...
set @srcFacID = '1'
set @SrcServer = '[pccsql-use2-prod-w24-cli0014.ce22455c967a.database.windows.net].[us_ctyd]'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].[us_magic_multi]'----change dst server & db name
