DECLARE  @srcFacID VARCHAR(100)		=	1
		,@dstFacID VARCHAR(100)		=	39
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w24-cli0014.ce22455c967a.database.windows.net].[us_ctyd]'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w22-cli0006.4c4638f8e26f.database.windows.net].[us_magic_multi]'
