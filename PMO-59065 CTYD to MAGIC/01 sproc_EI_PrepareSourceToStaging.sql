...
BEGIN
	...
	SET @EmailrecipientsExt = 'tshirely@majesticcare.com;Ashneet.Singh@pointclickcare.com;matt.s@pointclickcare.com;stephani.kish@pointclickcare.com;Harley.Esguerra@pointclickcare.com;BWegner@majesticcare.com;Brian.Grahame@pointclickcare.com;theresa.w@pointclickcare.com;Keya.Shah@pointclickcare.com;James.Creager@pointclickcare.com;TSFacAcqConfig@pointclickcare.com'
	...
	SET @action_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59065_ActionCodes$]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59065_StatusCodes$]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO59065_UploadCategories$]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59065_RoomRateType$]'
...
--E7d: MMQ, E7e: MMA, E16: Alert, E18: Trust, E19a: IRM, E19b: IRM, E23: Notes

--E14: Security Roles, E15: Security Users, E1: Resident Identifier, Contact, E2: Staff, E2a: Medical Professional, E3: External Facility, E4: User Defined Data, E5: Room and Bed, E6: Census, E7a: MDS 2, E7b: MDS 3, E7c: Custom UDAs, E8: Diagnosis, E12a: Custom Care Plan, E12b: Care Plan Copy Library, E11: Immunization, E9: Progress Note, E10: Vital, E13: Phys Orders, E17: Risk Management, E20: Upload Files, E21: Results Lab, Radiology, E22: Master Insurance