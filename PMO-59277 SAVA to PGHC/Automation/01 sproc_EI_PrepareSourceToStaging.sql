...
BEGIN
	...
	SET @vPMOGroupID = 1813

	/*------Job Fail Email Recipient------*/
	SET @vToEmailAddress = N'ashwin.chaudhari@pointclickcare.com;'

	/*------External Email Notification Recipient, for start of the run, email address only, semicolon separated------*/
	SET @EmailrecipientsExt = 'TS Fac Acq Configuration <TSFacAcqConfig@pointclickcare.com>; Tammi Irvine <Tammi.Irvine@pointclickcare.com>; Joseph Kostolich <joseph.kostolich@pointclickcare.com>; Tracy Enos <Tracy.Enos@pointclickcare.com>; Janie Tibaldi <Janie.Tibaldi@pointclickcare.com>; Cindy Clark <Cindy.Clark@pointclickcare.com>; Jason Boone <Jason.Boone@pointclickcare.com>;Raju Sivapalan <Raju.Sivapalan@pointclickcare.com>; Ashwin Chaudhari <Ashwin.Chaudhari@pointclickcare.com>; Robin Chow <robin.chow@pointclickcare.com>; Pilucci Mata <pilucci.mata@pacshc.com>; Barbara Maurer <barbara.maurer@pacshc.com>; Shannen Gonzalez <shannen.gonzalez@pacshc.com>; EHR Team DG <ehr.team@pacshc.com>;Melanie Crawford <melanie.crawford@pacshc.com>'
	...
	SET @action_codes_mapping_table			='[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59277_ActionCodes]'
	SET @status_codes_mapping_table			= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59277_StatusCodes]'
	SET @upload_categories_mapping_table	= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.[dbo].[PMO59277_UploadCateogaries]'
	SET @room_rate_type_mapping_table		= '[vmuspassvtsjob1.pccprod.local].FacAcqMapping.dbo.[PMO59277_RoomRateType]'
	...
	IF @vProdRun = 'Y'
	BEGIN
		SET @vPagerDutyOperator = 'FacAcqPagerTS4'
...
****************************************
***************************
Step 1: Setup Source Backup
***************************
****************************
Step 2: Setup Source Restore
****************************
*************************************************************
...
***********************************************
***************************************************************
Case No: 59277183 : Execute PreMergeScriptSrc on Source DB
***************************************************************
***************************************************************
Case No: 59277183 : Execute PreMergeScriptSrc on Source DB
***************************************************************
********************************************************************
Case No: 59277183 : Execute PreMergeScriptDst on Destination DB
********************************************************************
************************************************************
Case No: 59277183 : Execute PreMergeScript on Staging DB
************************************************************
*******************************************************************
Case No: 59277183 : Source to Staging Step3 and Step4 Execution
*******************************************************************
*************************************************************
Case No: 59277183 : Execute PostMergeScript on Staging DB
*************************************************************
*************************************************************************************************
Case No: 59277183 : Backup Staging DB for TS Team Use Only (In Case):- pcc_staging_db59277
*************************************************************************************************
********************************************
Backup Staging DB :- pcc_staging_db59277
********************************************
*******************************************************
Kickoff Staging to Destination Job :- EI_Prepare_Destination__59277
*******************************************************
**************************************************************
...
Completion time: 2022-02-28T08:15:16.7646485-05:00
