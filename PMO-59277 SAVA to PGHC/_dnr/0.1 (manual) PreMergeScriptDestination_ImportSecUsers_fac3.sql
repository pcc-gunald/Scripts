...
print  CHAR(13) + 'Starting to run script : cp_sec_user_audit - rescoping for fac R_SRCFACID3' 

if OBJECT_ID ('pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3','U') is not null
drop table pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3

select * into pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3 
--select *
...
where client_id in (select client_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].clients with (nolock) where fac_id = R_SRCFACID3)) and fac_id <> R_SRCFACID3)
and fac_id <> R_SRCFACID3 

insert into pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3 
select distinct s.* 
...
where b.fac_id = R_SRCFACID3 and s.fac_id <> R_SRCFACID3 --0
...
(select created_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select revision_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select published_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select retired_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order_set with (nolock) where fac_id  in (-1,R_SRCFACID3)
union 
select reactivated_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order_set with (nolock) where  fac_id  in (-1,R_SRCFACID3))
and fac_id <> R_SRCFACID3)
and fac_id <> R_SRCFACID3 
...
where userid in 
(select userid from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].cp_sec_user_audit with (nolock) where cp_sec_user_audit_id in 
(select created_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select revision_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select published_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select retired_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order with (nolock) where  fac_id  in (-1,R_SRCFACID3)
union 
select reactivated_by_audit_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_std_order with (nolock) where  fac_id  in (-1,R_SRCFACID3))
and fac_id <> R_SRCFACID3)
and fac_id <> R_SRCFACID3 
...
where b.client_id in (select client_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].clients with (nolock) where fac_id = R_SRCFACID3))  
...
where client_id in (select client_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].clients with (nolock) where fac_id in (R_SRCFACID3)))
and fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
where client_diagnosis_id in (select client_diagnosis_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].diagnosis with (nolock) where fac_id in (R_SRCFACID3)))
and fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
WHERE phys_order_id IN (SELECT distinct phys_order_id FROM [sqluspaw29cli01.pccprod.local].us_sava_multi.[dbo].pho_phys_order with (nolock) WHERE fac_id = R_SRCFACID3))
AND fac_id <> R_SRCFACID3)
and fac_id <> R_SRCFACID3
...
where custom_drug_id in (select custom_drug_id from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.cr_cust_med with (nolock) where fac_id in (-1,R_SRCFACID3))
union
...
where a.fac_id = R_SRCFACID3 and s.fac_id <> R_SRCFACID3

delete from pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3  where loginname like '%pcc-%' 

print  CHAR(13) + 'Ended running : cp_sec_user_audit - rescoping for fac R_SRCFACID3' 

print  CHAR(13) + 'Starting to run script : import GAP of security users for fac R_SRCFACID3' 

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_backup','U') is not null
select * into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_backup from sec_user

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_facility_backup','U') is not null
select * into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_facility_backup from sec_user_facility

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_physical_id_backup','U') is not null
select * into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_physical_id_backup from sec_user_physical_id

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_sameloginname','U') is not null
DROP TABLE pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_sameloginname

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name','U') is not null
DROP TABLE pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name

if OBJECT_ID ('pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_same_name','U') is not null
DROP TABLE pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_same_name

if OBJECT_ID ('dbo.EIcaseR_CASENUMBER3sec_user','U') is not null
DROP TABLE dbo.EIcaseR_CASENUMBER3sec_user
...
select  a.* into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_sameloginname
--select a.*
...
insert into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_sameloginname
select a.*
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
where a.userid in (select userid from pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3) 
and a.loginname not like '%pcc-%' 
and a.loginname  not like '%wescom%'
...
into dbo.EIcaseR_CASENUMBER3sec_user 
--select *
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user src 
where (fac_id = R_SRCFACID3 or userid in(select userid from pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3))
...
update  dbo.EIcaseR_CASENUMBER3sec_user  
...
SELECT map.dst_id
	...
	,sso_only_user
FROM [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user src
JOIN dbo.EIcaseR_CASENUMBER3sec_user map ON src.userid = map.src_id
WHERE src.userid NOT IN (SELECT userid FROM pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_sameloginname)
...
SELECT DISTINCT a.dst_id
	,R_DSTFACID3  
	,src.access_level
FROM dbo.EIcaseR_CASENUMBER3sec_user a join [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user_facility src
...
select  a.* into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
where a.fac_id = R_SRCFACID3
...
insert into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name
select a.*
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
where a.userid in (select userid from pcc_temp_storage.dbo._bkp_PMO59277_CaseR_CASENUMBER3_sec_user_import_pre_scoping_fac_R_SRCFACID3)--94 
and a.loginname not like '%pcc-%' and a.loginname  not like '%wescom%'
and a.long_username <> b.long_username
...
FROM  [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user src 
JOIN dbo.EIcaseR_CASENUMBER3sec_user map ON src.userid = map.src_id
and src_id IN (select userid from pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name)
and src.userid not in (select src_id from EICase59277183sec_user) 
and src.userid not in (select src_id from EICaseR_CASENUMBER2sec_user) 
...
FROM dbo.EIcaseR_CASENUMBER3sec_user a join [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user_facility src
on a.src_id = src.userid
JOIN pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name t on src.userid = t.userid
WHERE src.userid IN (SELECT userid FROM pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_different_name) 
and src.facility_id = R_SRCFACID3

--================================
--Step 3. Update table for testing
--================================
ALTER TABLE dbo.EICaseR_CASENUMBER3sec_user
add corporate char
GO
...
INSERT INTO dbo.EICaseR_CASENUMBER3sec_user (src_id,dst_id,corporate)
values (1,1,'Y')	
...
select  a.* into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_same_name
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
where a.fac_id = R_SRCFACID3
...
insert  into pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_same_name
select a.*
from [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.sec_user a
join dbo.sec_user b
on a.loginname = b.loginname
...
JOIN pcc_temp_storage.dbo.EIcaseR_CASENUMBER3_PGHC_sec_user_samelogin_same_name ln ON ln.userid = map.src_id
...
JOIN dbo.EICaseR_CASENUMBER3sec_user b ON b.src_id = src.userid  
AND b.corporate = 'N'
...
--select dst.*
from sec_user dst
join EIcaseR_CASENUMBER3sec_user m --sec_user mapping table
on dst.userid = m.dst_id
