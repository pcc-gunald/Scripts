...
update sec_user  
set fac_id = R_SRCFACID3
--select * from sec_user  
where userid in 
(select userid from cp_sec_user_audit where cp_sec_user_audit_id  in (select created_user_audit_id from as_footnote 
where client_id in (select client_id from clients where fac_id in (R_SRCFACID3))) and fac_id not in (R_SRCFACID3))
...
where b.fac_id in (R_SRCFACID3) and s.fac_id not in (R_SRCFACID3)
...
(select created_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select revision_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select published_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select retired_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select reactivated_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3))
and fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
where b.client_id in (select client_id from clients where fac_id in (R_SRCFACID3)))  
...
where fac_id in (R_SRCFACID3))) and  fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
where b.fac_id in (R_SRCFACID3) and s.fac_id not in (R_SRCFACID3) and (facility_id in (R_SRCFACID3) or admin_user_type ='E')
...
where client_id in (select client_id from clients where fac_id in (R_SRCFACID3)))
and fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
where client_diagnosis_id in (select client_diagnosis_id from diagnosis where fac_id in (R_SRCFACID3)))
and fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
and fac_id not in (R_SRCFACID3)
...
WHERE phys_order_id IN (SELECT distinct phys_order_id FROM pho_phys_order WHERE fac_id in (R_SRCFACID3)))
AND fac_id not in (R_SRCFACID3))
and fac_id not in (R_SRCFACID3)
...
where custom_drug_id in (select custom_drug_id from cr_cust_med where fac_id in (-1,R_SRCFACID3))
union
...
where a.fac_id IN (R_SRCFACID3) and s.fac_id not in (R_SRCFACID3)
...
WHERE cp_sec_user_audit_id IN (
		...
		WHERE pa.fac_id IN (R_SRCFACID3)
		)
	AND fac_id NOT IN (R_SRCFACID3)
	AND userid NOT IN (
		- 998
...
UPDATE cp_sec_user_audit 
SET fac_id = R_SRCFACID3 ,initials = null
--select * from cp_sec_user_audit 
where cp_sec_user_audit_id in (
...
JOIN pho_phys_order c on b.phys_order_id = c.phys_order_id 
WHERE c.fac_id in (R_SRCFACID3))  
and fac_id not in (R_SRCFACID3)) a
...
where cp_sec_user_audit_id in (
select created_by_audit_id from pho_std_order_set where  fac_id  in (-1,R_SRCFACID3)
union 
select revision_by_audit_id from pho_std_order_set where  fac_id  in (-1,R_SRCFACID3)
union 
select published_by_audit_id from pho_std_order_set where  fac_id  in (-1,R_SRCFACID3)
union 
select retired_by_audit_id from pho_std_order_set where  fac_id  in (-1,R_SRCFACID3)
union 
select reactivated_by_audit_id from pho_std_order_set where  fac_id  in (-1,R_SRCFACID3))
and fac_id not in (R_SRCFACID3) 
...
from cp_sec_user_audit a
where cp_sec_user_audit_id in (
select distinct created_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select distinct revision_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select distinct published_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select distinct retired_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3)
union 
select distinct reactivated_by_audit_id from pho_std_order where  fac_id  in (-1,R_SRCFACID3))
and fac_id not in (R_SRCFACID3) 
...
where b.fac_id = R_SRCFACID3 and c.fac_id <> R_SRCFACID3
...
where src.fac_id in (-1,R_SRCFACID3) 
...
on o.std_shift_id = s.std_shift_id and s.fac_id in (-1, R_SRCFACID3) 
where o.fac_id in (R_SRCFACID3) 
...
WHERE a.fac_id NOT IN (-1,R_SRCFACID3) 
	AND f.fac_id = R_SRCFACID3 
	AND a.system_flag <> 'Y'
	AND a.std_assess_id in (select distinct std_assess_id from dbo.as_assessment where fac_id = R_SRCFACID3) 
...
if @count > 0
	...
	where a.fac_id in (-1,R_SRCFACID3)
	AND s.fac_id not in (-1,R_SRCFACID3)
	AND a.system_flag <> 'Y'
	AND a.std_assess_id in (select distinct std_assess_id from dbo.as_assessment where fac_id = R_SRCFACID3) 
...
if @count > 0
	...
	where a.fac_id in (-1,R_SRCFACID3)
	AND r.fac_id not in (-1,R_SRCFACID3)
	AND a.system_flag <> 'Y'
	AND a.std_assess_id in (select distinct std_assess_id from dbo.as_assessment where fac_id = R_SRCFACID3)
	AND r.deleted <> 'Y'
...
where template_id  in (select template_id from pn_progress_note where fac_id = R_SRCFACID3)
and fac_id not in (-1,R_SRCFACID3)

update pn_type
set fac_id = R_SRCFACID3
--select * from pn_type
where pn_type_id  in (select pn_type_id from pn_progress_note where fac_id = R_SRCFACID3)
and fac_id not in (-1,R_SRCFACID3)
...
WHERE administered_by_id NOT IN (SELECT userid FROM dbo.sec_user )
	...
	AND client_id IN ( SELECT client_id FROM dbo.clients WHERE fac_id IN (R_SRCFACID3))
...
set fac_id = R_SRCFACID3
--select * from dbo.emc_ext_facilities
where ext_fac_id in (select ext_fac_id from dbo.client_ext_facilities where fac_id in (R_SRCFACID3))
and fac_id not in (-1,R_SRCFACID3)
...
and a.fac_id not in (-1,R_SRCFACID3)
...
--and su.fac_id = 183 
--and sf.facility_id = R_SRCFACID3 
...
----select * 
--from as_assessment_section where fac_id in (R_SRCFACID3) and completed_by_id is not null 

--update clients set case_manager_id = null
----select * 
--from clients where fac_id in (R_SRCFACID3) and case_manager_id is not null 

--update contact_history set user_id = -1
----select * 
--from contact_history where fac_id in (R_SRCFACID3) 

--update cp_rev_users set userid = -1
----select * 
--from cp_rev_users where fac_id in (R_SRCFACID3) 

--update cr_client_immunization set administered_by_id = null
----select * 
--from cr_client_immunization where fac_id in (R_SRCFACID3) and administered_by_id is not null 

--update cr_client_immunization_audit set administered_by_id = null
----select * 
--from cr_client_immunization_audit where fac_id in (R_SRCFACID3) and administered_by_id is not null 

--update mpi_history set user_id = -1
----select * 
--from mpi_history where fac_id in (R_SRCFACID3) and user_id is not null and user_id > 1

--update staff set userid = null
----select * 
--from staff where fac_id in (R_SRCFACID3) and userid is not null

--update pho_admin_order set noted_by = null
----select * 
--from pho_admin_order where phys_order_id in 
--(select phys_order_id from pho_phys_order where fac_id in (R_SRCFACID3)) 
...
----select * 
--from pho_report_run where fac_id in (R_SRCFACID3) 
--and user_id is not null 

--update pho_user_admin_rec_assoc set userid = null
----select * 
--from pho_user_admin_rec_assoc where fac_id in (R_SRCFACID3) 
--and userid is not null 

--update pho_phys_order_esignature set marked_to_sign_user_id = null
----select * 
--from pho_phys_order_esignature 
--where phys_order_id in  (select phys_order_id from pho_phys_order where fac_id in (R_SRCFACID3)) 
...
where src.std_assess_id in 
	...
	select std_assess_id from as_std_assessment stda
		where stda.std_assess_id <> - 1 AND (stda.fac_id = R_SRCFACID3 --src fac_id
				OR stda.fac_id = - 1
				OR stda.reg_id in (select regional_id from facility where fac_id = R_SRCFACID3)) --src fac_id
			...
			AND not exists (select 1 from as_assessment with (nolock) where std_assess_id = stda.std_assess_id and client_id = -9999
									and (fac_id = R_SRCFACID3  --src fac_id
									OR fac_id = -1 OR reg_id in (select regional_id from facility where fac_id = R_SRCFACID3))  --src fac_id
							)
	)
and client_id = -9999
...
and not exists (select 1 from as_assessment where a.std_assess_id = std_assess_id and client_id = -9999 and fac_id in (R_SRCFACID3,-1)) --src fac_id
...
and a.fac_id not in (R_SRCFACID3, -1) --src fac_id
