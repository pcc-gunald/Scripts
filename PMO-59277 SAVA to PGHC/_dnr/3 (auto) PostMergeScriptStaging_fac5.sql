...
SET fac_id = -1
--select * 
from sec_role WHERE created_by = 'EICaseR_CASENUMBER5'
AND role_id IN (SELECT dst_id FROM EICaseR_CASENUMBER5sec_role 
...
update  cr_std_alert
set  fac_id = -1
where  std_alert_id in (select  dst_id from  EIcaseR_CASENUMBER5cr_Std_alert where corporate='N'
...
where pick_list_item_id in (select dst_id from EICaseR_CASENUMBER5inc_std_pick_list_item where corporate='N'
...
where cat_id in (select dst_id from EICaseR_CASENUMBER5UPLOAD_CATEGORIES where  corporate='N'
...
where insurance_id in (select dst_id from EIcaseR_CASENUMBER5ar_lib_insurance_companies where corporate = 'N'
...
where address_id in (select dst_id from EIcaseR_CASENUMBER5ar_insurance_addresses where corporate = 'N'
...
set  fac_id = -1, revision_by = 'EIcaseR_CASENUMBER5', revision_Date = getdate()
--select * 
from dbo.cp_std_library where created_by = 'EICaseR_CASENUMBER5'
AND library_id in (select dst_id from  EIcaseR_CASENUMBER5cp_std_library 
...
WHERE created_by = 'EICaseR_CASENUMBER5'
AND library_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5cp_std_library)
AND need_cat_id in (select dst_id FROM EIcaseR_CASENUMBER5cp_std_need_cat where corporate = 'N'
...
FROM cp_std_need
WHERE created_by = 'EICaseR_CASENUMBER5' 
AND need_cat_id in (select need_cat_id FROM cp_std_need_cat WHERE library_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5cp_std_library))
AND std_need_id in (select dst_id from EICaseR_CASENUMBER5cp_std_need where corporate = 'N'
...
AND std_need_id in (select std_need_id from cp_std_need where need_cat_id in 
							(select need_cat_id from cp_std_need_cat where library_id in 
									(select dst_id from EIcaseR_CASENUMBER5cp_std_library)))
AND std_goal_id in (select dst_id from EICaseR_CASENUMBER5cp_std_goal where corporate = 'N'
...
AND std_need_id in (select std_need_id from cp_std_need 
							...
							where library_id in (select dst_id from EIcaseR_CASENUMBER5cp_std_library)))
AND std_intervention_id in (select dst_id from EICaseR_CASENUMBER5cp_std_intervention where corporate = 'N'
...
AND std_need_id in (select std_need_id from cp_std_need 
							where need_cat_id in (select need_cat_id from cp_std_need_cat 
							where library_id in (select dst_id from EIcaseR_CASENUMBER5cp_std_library)))
AND std_etiologies_id in (select dst_id from EICaseR_CASENUMBER5cp_std_etiologies where corporate = 'N'
...
WHERE std_schedule_id IN (SELECT dst_id FROM EICaseR_CASENUMBER5cp_std_schedule WHERE corporate = 'N'
...
where category_id in (select dst_id from EIcaseR_CASENUMBER5cp_kardex_categories where  corporate='N'
...
where  std_assess_id in  (select  dst_id from EIcaseR_CASENUMBER5as_std_assessment where corporate='N'
...
where  std_trigger_id in  (select  dst_id from EIcaseR_CASENUMBER5as_std_trigger where corporate='N'
...
where  schedule_id in  (select  dst_id from EIcaseR_CASENUMBER5as_std_assess_schedule where corporate='N' 
...
where  consistency_rule_id in  (select  dst_id from EIcaseR_CASENUMBER5as_consistency_rule where corporate='N'
...
where  std_profile_consistency_id in  (select  dst_id from EIcaseR_CASENUMBER5as_std_profile_consistency where corporate='N'
...
where std_highrisk_id in  (select  dst_id from EIcaseR_CASENUMBER5CR_STD_HIGHRISK_DESC where corporate = 'N'
...
WHERE template_id IN (SELECT dst_id	FROM EIcaseR_CASENUMBER5pn_template WHERE corporate = 'N'
...
SET fac_id = -1
--select  *  from  pn_type
WHERE pn_type_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5pn_type WHERE corporate = 'N'
...
WHERE order_type_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5pho_order_type	WHERE corporate = 'N'
...
where administration_record_id  in (select dst_Id from EIcaseR_CASENUMBER5pho_administration_record WHERE corporate = 'N'
...
where std_phys_order_id in (select dst_Id from EIcaseR_CASENUMBER5pho_std_phys_order WHERE corporate = 'N'
...
where order_group_id in (select dst_id from EIcaseR_CASENUMBER5pho_order_group where corporate = 'N'
...
where order_group_item_id in  (select dst_id from EIcaseR_CASENUMBER5pho_order_group_item where corporate = 'N'
...
where pho_std_time_id in (select dst_id from EICaseR_CASENUMBER5pho_std_time where corporate='N'
...
where pho_std_time_details_id in (select dst_id from EICaseR_CASENUMBER5pho_std_time_details where  corporate='N'
...
where std_order_set_id in (select dst_id from EIcaseR_CASENUMBER5pho_std_order_set where  corporate='N'
...
where std_order_id in (select dst_id from  EIcaseR_CASENUMBER5pho_std_order where  corporate = 'N'
...
where  custom_drug_id in  (select  dst_id from  EIcaseR_CASENUMBER5cr_cust_med where corporate='N'
...
set  fac_id = -1
where created_by = 'EIcaseR_CASENUMBER5'
and std_freq_id in (select dst_id from EIcaseR_CASENUMBER5cp_std_frequency WHERE corporate = 'N'
...
where created_by = 'EIcaseR_CASENUMBER5'
AND std_shift_id in (select dst_id from EICaseR_CASENUMBER5cp_std_shift where corporate = 'N'
...
where created_by = 'EIcaseR_CASENUMBER5'
and diagnosis_id IN (SELECT dst_id FROM EICaseR_CASENUMBER5diagnosis_codes WHERE corporate = 'N'
...
SET fac_id = -1
--select  *  
from id_type WHERE created_by = 'EICaseR_CASENUMBER5'
AND id_type_id in (SELECT dst_id FROM EICaseR_CASENUMBER5id_type
...
SET fac_id = -1
--select  *  
from emc_ext_facilities WHERE created_by = 'EICaseR_CASENUMBER5' 
AND ext_fac_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5emc_ext_facilities
...
set  fac_id=-1
--select * 
from user_field_types where created_by = 'EICaseR_CASENUMBER5'
AND field_type_id IN (SELECT dst_id FROM EIcaseR_CASENUMBER5user_field_types
...
and item_id in (select dst_id from EIcaseR_CASENUMBER5common_code 
...
where item_id in (select dst_id from EICaseR_CASENUMBER5census_codes where  corporate='N'
...
where  created_by='EIcaseR_CASENUMBER5'--0
AND std_immunization_id in (select  dst_id from  EIcaseR_CASENUMBER5cr_std_immunization where corporate='N'
