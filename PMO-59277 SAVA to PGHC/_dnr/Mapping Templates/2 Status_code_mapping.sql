...
INTO #src_statuses FROM [sqluspaw29cli01.pccprod.local].us_sava_multi.dbo.census_codes WITH (NOLOCK)
...
INTO #dst_statuses FROM [pccsql-use2-prod-w30-cli0004.cbafa2b80e84.database.windows.net].us_pghc_multi.dbo.census_codes WITH (NOLOCK)
...
FROM #src_statuses AS src FULL JOIN #dst_statuses AS dst ON src.rownum = dst.rownum
