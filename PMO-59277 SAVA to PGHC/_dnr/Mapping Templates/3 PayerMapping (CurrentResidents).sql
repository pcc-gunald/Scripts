DECLARE @srcFacID VARCHAR(100)		=	--183
		,@dstFacID VARCHAR(100)		=	--173
		,@srcServer VARCHAR(500)	=	'[sqluspaw29cli01.pccprod.local].us_sava_multi'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w30-cli0004.cbafa2b80e84.database.windows.net].us_pghc_multi'
		,@dischargedate VARCHAR(100)=	'''R_CURRESDATE'''
