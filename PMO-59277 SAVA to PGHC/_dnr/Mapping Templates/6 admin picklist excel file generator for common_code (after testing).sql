...
set @CaseNumber = 'EICase59277'
set @SrcServer = '[vmuspassvtscon3.pccprod.local].test_usei3sava1'----change src server & db name
set @DstServer = '[pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei1214'----change dst server & db name
