...
--CREATE TABLE [dbo].[EIcaseR_CASENUMBER8sec_user]( 
...
--select row_id, src_id,dst_id,corporate from [pccsql-use2-prod-ssv-tscon14.b4ea653240a9.database.windows.net].test_usei1214.dbo.EIcaseR_CASENUMBER8sec_user
...
--CREATE TABLE [dbo].[EICaseR_CASENUMBER8pn_progress_note](  
--[row_id] [int] IDENTITY(1,1) NOT NULL,
--[src_id] [bigint] NULL,
--[dst_id] [bigint] NULL,
--[corporate] [char](1) NULL DEFAULT ('N')
