DECLARE @srcFacID VARCHAR(100)		=	107 
		,@dstFacID VARCHAR(100)		=	99
		,@srcServer VARCHAR(500)	=	'[pccsql-use2-prod-w19-cli0012.3055e0bc69f6.database.windows.net].us_elvt_multi'
		,@dstServer VARCHAR(500)	=	'[pccsql-use2-prod-w28-cli0007.874bf44c721a.database.windows.net].us_swc_multi'
