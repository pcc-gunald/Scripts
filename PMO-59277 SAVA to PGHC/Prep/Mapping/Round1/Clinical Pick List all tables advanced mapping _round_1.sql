...
set @srcFacID = '183'
set @SrcServer = '[sqluspaw29cli01.pccprod.local].us_sava_multi'----change src server & db name
set @DstServer = '[pccsql-use2-prod-w30-cli0004.cbafa2b80e84.database.windows.net].[us_pghc_multi]'----change dst server & db name
