...
set @CaseNumber = 'EICase44474'--use the root case number, keep the 'EICase'
set @SrcServer = '[UDS2\DS4].test_usei57'----change src server & db name
set @DstServer = '[UDS2\DS4].test_usei58'----change dst server & db name
