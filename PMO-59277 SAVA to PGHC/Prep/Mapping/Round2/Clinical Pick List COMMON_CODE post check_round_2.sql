...
set @CaseNumber = 'EICase44909'--use the root case number, keep the 'EICase'
set @SrcServer = '[uds2\ds4].test_usei60'----change src server & db name
set @DstServer = '[uds1\ds2].[test_usei201]'----change dst server & db name
