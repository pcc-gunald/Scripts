...
set @CaseNumber = 'EICase1652735'--use the root case number, keep the 'EICase'
set @SrcServer = '[CDS1\DS1].cdn_cdnhd4'----change src server & db name
set @DstServer = '[CDS1\DS1].cdn_cdnei7'----change dst server & db name
