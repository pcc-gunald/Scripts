...
set @CaseNumber = 'EICase1582279'--use the root case number, keep the 'EICase'
set @SrcServer = '[UDS2\DS3].test_usei5'----change src server & db name
set @DstServer = '[UDS2\DS4].test_usei74'----change dst server & db name
